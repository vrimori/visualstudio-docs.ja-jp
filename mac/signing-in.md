---
title: "Visual Studio for Mac にサインインする | Microsoft Docs"
description: 
author: asb3993
ms.author: amburns
ms.date: 04/14/2017
...
追加ユーザー アカウントを追加するには、「[Visual Studio for Mac にサインインする方法](#How_to_sign_in_to_Visual_Studio_for_Mac)」セクションの手順に従います。
