...
description: "このドキュメントでは、Xamarin Studio のプロジェクトとソリューションの概要を示します。"
author: asb3993
ms.author: amburns
ms.date: 04/14/2017
ms.topic: article
...
新しいプロジェクトまたはソリューションを作成する場合は、「[Creating new Projects and Solutions](~/create-new-projects.md)」 (新しいプロジェクトとソリューションの作成) を参照してください。
