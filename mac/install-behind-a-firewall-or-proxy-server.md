...
- [ファイアウォールまたはプロキシ サーバーの内側に Visual Studio 2017 および Azure Services をインストールして使用する](https://docs.microsoft.com/visualstudio/install/install-and-use-visual-studio-behind-a-firewall-or-proxy-server)
- [Windows に関する同様の問題のトラブルシューティング](https://docs.microsoft.com/visualstudio/install/troubleshooting-network-related-errors-in-visual-studio)