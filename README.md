...
Visual Basic と Visual C# のドキュメントは別のリポジトリ [http://github.com/dotnet/core-docs](http://github.com/dotnet/core-docs) にあり、Visual C++ のドキュメントは [http://github.com/Microsoft/cpp-docs](http://github.com/Microsoft/cpp-docs) のリポジトリにあります。
