---
title: クラウドで Kubernetes を使用して、コンテナーを含む .NET Core 開発環境を作成する - 手順 1 - ツールをインストールする | Microsoft Docs
author: ghogen
ms.author: ghogen
ms.date: 04/05/2018
ms.topic: tutorial
...
これで、Azure で Kubernetes ベースの開発環境を作成する準備ができました。

> [!div class="nextstepaction"]
> [Azure で開発環境を作成する](get-started-netcore-02.md)
