---
title: クラウドで Kubernetes を使用して、コンテナーを含む Node.js 開発環境を作成する - 手順 2 - Kubernetes 開発環境を作成する | Microsoft Docs
author: ghogen
ms.author: ghogen
ms.date: 02/20/2018
ms.topic: tutorial
...
> [Kubernetes で Node.js コンテナーを作成する](get-started-nodejs-03.md)
