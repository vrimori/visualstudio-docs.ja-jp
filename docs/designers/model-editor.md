...
## 作業の開始  
 ここでは、[!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] プロジェクトへの 3\-D モデルの追加方法と、開始するために必要な基本情報について説明します。  
  
#### プロジェクトに 3\-D モデルを追加するには  
...
### 軸の向き  
 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] は、3\-D 軸の任意の向きをサポートし、それをサポートするモデル ファイル形式から軸の向きに関する情報を読み込みます。  軸の向きを指定しない場合、[!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] は右手座標系を既定で使用します。  **\[軸インジケーター\]** は、現在の軸の向きをデザイン サーフェイスの右下隅に示します。  **\[軸インジケーター\]** では、赤は x 軸を、緑は y 軸を、青は z 軸を表します。  
...
### モデル エディターのツール バー  
 ...
 モデル エディターの状態に影響を与えるコマンドはメイン [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] ウィンドウの **\[モデル エディターのモード\]** ツール バーにあります。  モデリング ツールおよびスクリプト化されたコマンドは、モデル エディターのデザイン サーフェイスの **\[モデル エディター\]** ツール バーにあります。  
...
|**軌道**|選択したオブジェクトの周囲の円形パスにビューを配置します。  オブジェクトが選択されていない場合、パスはシーンの原点を中心に配置されます。 **Note:**  このモードは **\[正投影\]** が有効になっている場合は影響がありません。|  
...
|**ビュー**|ビューの向きを設定します。  使用できる向きを次に示します。<br /><br /> **前面**<br /> シーンの前面にビューを配置します。<br /><br /> **背面**<br /> シーンの背面にビューを配置します。<br /><br /> **左**<br /> シーンの左側にビューを配置します。<br /><br /> **右**<br /> シーンの右側にビューを配置します。<br /><br /> **このページのトップへ**<br /> シーンの上部にビューを配置します。<br /><br /> **Bottom**<br /> シーンの下部にビューを配置します。 **Note:**  **\[正投影\]** を有効にした場合、ビューの向きはこの方法でのみ変更されます。|  
...
|**オブジェクトの選択**|**\[選択モード\]** をオブジェクト全体を選択するに設定します。|  
...
|コマンド|キーボード ショートカット|  
|----------|-------------------|  
|**\[選択\]** モードに切り替えます。|Ctrl \+ G、Gtrl \+ Q<br /><br /> S|  
|**\[ズーム\]** モードに切り替えます。|Ctrl \+ G、Ctrl \+ Z<br /><br /> Z|  
|**\[パン\]** モードに切り替えます。|Ctrl \+ G、Ctrl \+ P<br /><br /> K|  
|すべて選択|Ctrl \+ A|  
|現在の選択範囲を削除します。|\[Delete\]|  
|現在の選択を取り消します。|エスケープ特殊文字|  
|ズーム イン|マウス ホイール前方移動<br /><br /> Ctrl \+ マウス ホイール前方移動<br /><br /> Shift \+ マウス ホイール前方移動<br /><br /> Ctrl \+ PageUp キー<br /><br /> プラス記号 \(\+\)|  
...
|タイトル|説明|  
|----------|--------|  
|[ゲームとアプリケーション用の 3D アセットの操作](../designers/working-with-3-d-assets-for-games-and-apps.md)|テクスチャ、イメージ、3\-D モデルやシェーダー効果などのグラフィックス資産の操作に使用できる [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] のツールの概要を説明します。|  
|[イメージ エディター](../designers/image-editor.md)|[!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] イメージ エディターを使用してテクスチャとイメージを操作する方法について説明します。|  
