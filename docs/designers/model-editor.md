...
|**リアルタイム レンダリング モード**|リアルタイム レンダリングを有効にすると、ユーザー動作がない場合でも、[!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] でデザイン サーフェイスを再描画します。 このモードは、時間と共に変化するシェーダーを使用する場合に役立ちます。|  
