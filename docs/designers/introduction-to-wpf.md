...
##  <a name="Controls"></a> コントロール  
 ...
 詳しくは、「[コントロール](../Topic/Controls.md)」をご覧ください。  
...
### 2\-D ジオメトリ  
 ...
 ![パスのさまざまな使用](../designers/media/wpfintrofigure5.png "WPFIntroFigure5")  
...
### イメージ  
 ...
 ![サムネイル イメージとフルサイズのイメージ](../designers/media/wpfintrofigure8.png "WPFIntroFigure8")  
