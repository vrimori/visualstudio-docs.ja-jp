...
Windows Presentation Foundation (WPF) を使用して、視覚的に美しいユーザー エクスペリエンスを持つ Windows 用のデスクトップ クライアント アプリケーションを作成できます。  
 ...
 ![Contoso Healthcare UI のサンプル](~/docs/designers/media/wpfintrofigure24.png "WPFIntroFigure24")  
...
```  
 ...
 ![ボタンを含むウィンドウ](~/docs/designers/media/wpfintrofigure10.png "WPFIntroFigure10")  
...
>  子コントロールが使うために、親コントロールにより実装されるプロパティは、 [添付プロパティ](https://msdn.microsoft.com/en-us/library/ms749011\(v=vs.100\).aspx)と呼ばれる WPF 構成要素です。  
 ...
 ![DockPanel ページ](~/docs/designers/media/wpfintrofigure11.png "WPFIntroFigure11")  
...
### <a name="2-d-shapes"></a>2-D 図形  
 ...
 ![楕円と四角形](~/docs/designers/media/wpfintrofigure4.PNG "WPFIntroFigure4")  
 ...
 !["you clicked the ellipse&#33;" というテキストを含むウィンドウ](~/docs/designers/media/wpfintrofigure12.png "WPFIntroFigure12")  
...
### <a name="2-d-geometries"></a>2-D ジオメトリ  
 ...
 ![パスのさまざまな使用方法](~/docs/designers/media/wpfintrofigure5.PNG "WPFIntroFigure5")  
...
### <a name="2-d-effects"></a>2-D 効果  
 ...
 ![さまざまなブラシの図](~/docs/designers/media/wpfintrofigure6.PNG "WPFIntroFigure6")  
...
### <a name="3-d-rendering"></a>3-D レンダリング  
 ...
 ![Visual3D サンプルのスクリーンショット](~/docs/designers/media/wpfintrofigure13.png "WPFIntroFigure13")  
...
##  <a name="Animation"></a> アニメーション  
 ...
 ![アニメーション キューブのイメージ](~/docs/designers/media/wpfintrofigure7.png "WPFIntroFigure7")  
...
### <a name="images"></a>イメージ  
 ...
 ![サムネイル イメージとフルサイズ イメージ](~/docs/designers/media/wpfintrofigure8.PNG "WPFIntroFigure8")  
...
### <a name="video-and-audio"></a>ビデオとオーディオ  
 ...
 ![オーディオおよびビデオを含む MediaElement コントロール](~/docs/designers/media/wpfintrofigure1.png "WPFIntroFigure1")  
...
-   国際対応フォントのサポートとフォールバック メカニズム。  
 ...
 ![さまざまなテキスト装飾を含むテキスト](~/docs/designers/media/wpfintrofigure23.png "WPFIntroFigure23")  
...
[!code-xml[IntroToWPFSnippets#TextBoxContentMARKUP3](../designers/codesnippet/Xaml/introduction-to-wpf_12.xaml)]  
 ...
 ![テキストを含む TextBox コントロール](~/docs/designers/media/wpfintrofigure21.png "WPFIntroFigure21")  
...
[!code-xml[IntroToWPFSnippets#ButtonContentMARKUP3](../designers/codesnippet/Xaml/introduction-to-wpf_15.xaml)]  
 ...
 ![複数の種類の内容を含むボタン](~/docs/designers/media/wpfintrofigure22.png "WPFIntroFigure22")  
...
### <a name="control-templates"></a>コントロール テンプレート  
 ...
 ![省略記号ボタンと 2 番目のウィンドウ](~/docs/designers/media/wpfintrofigure2.png "WPFIntroFigure2")  
...
### <a name="data-templates"></a>データ テンプレート  
 ...
 ![既定の外観を使用したリスト ボックス](~/docs/designers/media/wpfintrofigure18.png "WPFIntroFigure18")  
...
[!code-xml[IntroToWPFSnippets#DataTemplateMARKUP4](../designers/codesnippet/Xaml/introduction-to-wpf_21.xaml)]  
 ...
 ![データ テンプレートを使用するリスト ボックス](~/docs/designers/media/wpfintrofigure19.png "WPFIntroFigure19")  
...
[!code-xml[IntroToWPFSnippets#StyleMARKUP4](../designers/codesnippet/Xaml/introduction-to-wpf_25.xaml)]  
 ...
 ![2 つのオレンジ色のボタン](~/docs/designers/media/wpfintrofigure20.png "WPFIntroFigure20")  
...
-   **フレームワーク要素モデル** カスタム コントロールは、カスタム レンダリング ロジック (テンプレートではなく) によって外観が定義されるときに、 <xref:System.Windows.FrameworkElement> から派生します。  
 ...
 ![カスタム UserControl](~/docs/designers/media/wpfintrofigure3.png "WPFIntroFigure3")  
