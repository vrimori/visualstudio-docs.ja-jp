...
|詳細情報|解決方法については、|  
|----------|----------------|  
|Visual Studio または Blend for Visual Studio を使用した XAML ベースのアプリやアプリケーションの設計。   .|[Designing XAML in Visual Studio and Blend for Visual Studio](../designers/designing-xaml-in-visual-studio.md)|  
