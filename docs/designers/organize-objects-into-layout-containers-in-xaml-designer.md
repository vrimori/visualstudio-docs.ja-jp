 ...
 **短いビデオを見る:** ![インストール済みフィーチャーの構成](~/designers/media/bldadminconsoleinitialconfigicon.PNG "BldAdminConsoleInitialConfigIcon") [グリッドを使用する](http://www.popscreen.com/v/6A4hj/Microsoft-Expression-Blend-Using-Grids)  
 ...
 **短いビデオを見る:** ![インストール済みフィーチャーの構成](~/designers/media/bldadminconsoleinitialconfigicon.PNG "BldAdminConsoleInitialConfigIcon") [UniformGrid を使用する](http://www.popscreen.com/v/6A4iq/Microsoft-Expression-Blend-Working-with-a-UniformGrid)  
 ...
 **短いビデオを見る:** ![インストール済みフィーチャーの構成](~/designers/media/bldadminconsoleinitialconfigicon.PNG "BldAdminConsoleInitialConfigIcon") [キャンバスを使用する](http://www.popscreen.com/v/6A4hT/Microsoft-Expression-Blend-Working-with-the-Canvas)  
 ...
 **短いビデオを見る:** ![インストール済みフィーチャーの構成](~/designers/media/bldadminconsoleinitialconfigicon.PNG "BldAdminConsoleInitialConfigIcon") [StackPanel と WrapPanel を使用する](http://www.popscreen.com/v/6A4i5/Microsoft-Expression-Blend-Using-the-StackPanel-and-WrapPanel)  
 ...
 **短いビデオを見る:** ![インストール済みフィーチャーの構成](~/designers/media/bldadminconsoleinitialconfigicon.PNG "BldAdminConsoleInitialConfigIcon") [境界線を使用する](http://www.popscreen.com/v/6A4hB/Microsoft-Expression-Blend-Working-with-Borders)  
