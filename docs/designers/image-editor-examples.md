...
|[ゲームまたはアプリでの 3-D アセットの使用](../designers/using-3-d-assets-in-your-game-or-app.md)|プロジェクトまたはソリューションのビルド時に [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] を使用してアプリ用に 3-D アセットを処理する方法について説明します。 さまざまな種類のアセットをアプリに読み込む手法についても説明します。|  
