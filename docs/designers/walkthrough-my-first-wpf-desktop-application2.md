...
5.  [XAML] ウィンドウで **[高さ]** 要素の値を `375`に設定し、 **[幅]** プロパティの値を `500`の順にクリックします。  
...
5.  メニュー バーで、 **[デバッグ]**、 **[デバッグ開始]** の順に選択して (または F5 キーを押して) アプリケーションを実行します。  
     ...
     ![ExpenseIt のサンプルのスクリーン ショット](~/docs/designers/media/gettingstartedfigure1.png "GettingStartedFigure1")  
...
3.  アプリケーションをビルドして実行します。 次の図は、この手順によって XAML で作成されるコントロールの実行時の外観を示しています。  
     ...
     ![ExpenseIt のサンプルのスクリーン ショット](~/docs/designers/media/gettingstartedfigure2.png "GettingStartedFigure2")  
...
6.  この時点でアプリケーションをビルドして実行すると、次の図のようになります。  
     ...
     ![ExpenseIt のサンプルのスクリーン ショット](~/docs/designers/media/gettingstartedfigure3.png "GettingStartedFigure3")  
