...
####  <a name="a-namewwsmaterialparametersa-textures-and-material-parameters"></a><a name="WWS_MaterialParameters"></a> テクスチャおよび素材パラメーター  
...
|[イメージ エディター](../designers/image-editor.md)|
          [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] イメージ エディターを使用してテクスチャとイメージを操作する方法について説明します。|  
