...
#### <a name="wcf-templates"></a>WCF テンプレート
 WCF Visual Studio テンプレートでは、サービスの開発の基本クラスの構造を提供します。 いくつかの WCF テンプレートは、**新しいプロジェクトの追加** ダイアログ ボックス。 WCF サービス ライブラリ プロジェクト、WCF サービスの Web サイト、および WCF サービス項目テンプレートが含まれます。
