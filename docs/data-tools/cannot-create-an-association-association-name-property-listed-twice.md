---
title: 関連付けのプロパティが 2 回一覧表示を作成できません。
ms.date: 11/04/2016
ms.topic: reference
...
関連付けを定義して、選択した**関連付けのプロパティ**で、 **[関連付けエディター** ] ダイアログ ボックス。 プロパティは、関連付けのクラスごとに 1 回のみリストできます。

メッセージのプロパティには、親または子のいずれかのクラスの 1 つ以上の時間が表示されます。**関連付けのプロパティ**です。
