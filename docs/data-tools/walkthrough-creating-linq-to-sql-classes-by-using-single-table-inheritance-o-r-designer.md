...
## <a name="see-also"></a>関連項目  
 ...
 [方法: Visual Basic または c# でのオブジェクト モデルの生成](/dotnet/framework/data/adonet/sql/linq/how-to-generate-the-object-model-in-visual-basic-or-csharp)