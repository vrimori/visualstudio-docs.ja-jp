---
title: IntelliTrace ステップ バックを使用してスナップショットを表示します。
...
ms.locfileid: "46495760"
---
# <a name="view-snapshots-using-intellitrace-step-back-in-visual-studio"></a>Visual Studio の IntelliTrace ステップ バックを使用してスナップショットの表示
