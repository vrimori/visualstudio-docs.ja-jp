---
title: IDiaEnumInjectedSources::get__NewEnum |Microsoft ドキュメント
ms.custom: ''
ms.date: 11/04/2016
...
#### <a name="parameters"></a>パラメーター  
 pRetVal  
 [out, retval]返します、`IUnknown`を表すインターフェイスを<xref:System.Runtime.InteropServices.ComTypes.IEnumVARIANT>この列挙子のバージョン。  
