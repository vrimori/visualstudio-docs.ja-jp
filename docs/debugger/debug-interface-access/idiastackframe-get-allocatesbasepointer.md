---
title: IDiaStackFrame::get_allocatesBasePointer |Microsoft ドキュメント
ms.custom: ''
ms.date: 11/04/2016
...
#### <a name="parameters"></a>パラメーター  
 `pRetVal`  
 [out]返します`TRUE`; このフレーム内のコード ベースへのポインターが割り当てられている場合を返しますそれ以外の場合、`FALSE`です。  
