...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "Dia2dump サンプル [DIA SDK]、サンプル ソース"
...
manager: "ghogen"
---
# Dia2dump.cpp ソース ファイル
[!INCLUDE[vs2017banner](../../code-quality/includes/vs2017banner.md)]

次の Dia2dump.cpp のソース・コードは .pdb ファイルの内容が表示されます。  このソース・コードは [Dia2dump サンプル](../../debugger/debug-interface-access/dia2dump-sample.md) によって使用されます。  
