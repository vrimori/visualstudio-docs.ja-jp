---
title: Dia2dump.cpp ソース ファイル |Microsoft ドキュメント
ms.custom: ''
ms.date: 11/04/2016
...
ms.locfileid: "31466059"
---
# <a name="dia2dumpcpp-source-file"></a>Dia2dump.cpp ソース ファイル
次の Dia2dump.cpp ソース コードでは、.pdb ファイルの内容を表示します。 このソース コードを使って[Dia2dump サンプル](../../debugger/debug-interface-access/dia2dump-sample.md)です。  
