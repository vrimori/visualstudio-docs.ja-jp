...
-   グラフィックス ログのドキュメントの上部で、レンダー ターゲットの出力から目的のピクセルを選択します。 使用することができます、ピクセルを選択した場合、**グラフィックス ピクセル履歴**選んだピクセルに関する詳細情報を表示するウィンドウ。 詳細については、次を参照してください。[ピクセル履歴](graphics-pixel-history.md)します。  
...
## <a name="playback-machine"></a>再生コンピューター  
 ...
 再生コンピューターを指定する方法については、次を参照してください。[方法: グラフィックス診断再生マシンを変更](how-to-change-the-graphics-diagnostics-playback-machine.md)します。  
