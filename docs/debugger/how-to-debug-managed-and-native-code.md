---
title: 'チュートリアル: マネージド コードおよびネイティブ コードをデバッグする (混在モード)'
...
---
# <a name="tutorial-debug-managed-and-native-code-in-the-same-debugging-session"></a>チュートリアル: マネージド コードとネイティブ コードを同じデバッグ セッション内でデバッグする
