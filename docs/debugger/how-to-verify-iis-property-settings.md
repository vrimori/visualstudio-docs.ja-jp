...
6. [!INCLUDE[vstecasp](../code-quality/includes/vstecasp_md.md)]アプリケーションでは、必ず仮想フォルダー、アプリケーション設定されたアプリケーション名**インターネット インフォメーション サービス (IIS) マネージャー**、**インターネット サービス マネージャー**または**インターネット インフォメーション サービス**します。  
