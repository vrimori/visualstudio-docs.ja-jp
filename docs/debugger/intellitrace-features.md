...
スナップショットは、Visual Studio Enterprise 2017 15.5 以降のバージョンで使用できる、Windows 10 Anniversary 更新を必要とまたはそれ以降。  スナップショットは、.NET Core と ASP.NET Core アプリケーションの現在ご利用いただけません。
