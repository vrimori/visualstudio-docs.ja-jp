...
Visual Studio Graphics Analyzer でグラフィックス イベント一覧を使用して、ゲームまたはアプリのフレームのレンダリング中に記録された Direct3D イベントを調査できます。  
 ...
 ![その名前に "インデックス" が含まれているイベントのリスト。](../debugger/media/gfx_diag_demo_event_list_orientation.png "gfx_diag_demo_event_list_orientation")  
...
|![描画イベント アイコン](../debugger/media/vsg_eventlist_icon_draw.png "vsg_eventlist_icon_draw")|描画イベント<br /> キャプチャしたフレームの間に	発生した描画イベントをマークします。|  
|![ユーザー定義イベント マーカーのアイコン](../debugger/media/vsg_eventlist_icon_user.png "vsg_eventlist_icon_user")|ユーザー定義イベント グループ<br /> アプリケーションで定義されているとおりに、関連するイベントをグループ化します。|  
|![ユーザー定義イベント マーカーのアイコン](../debugger/media/vsg_eventlist_icon_user.png "vsg_eventlist_icon_user")|ユーザー定義イベント マーカー<br /> アプリケーションで定義されているとおりに、特定の場所をマークします。|  
...
|---------------------|----------------------------------------------------------------------------|-----------------------------------------------------------------------------------|  
|ユーザー定義のイベントの可用性を確認する|[PIXGetStatus](http://msdn.microsoft.com/ja-jp/f7ebd985-fb5d-46d7-abec-099df4b9be0e)|[PIXGetStatus](http://msdn.microsoft.com/ja-jp/1046ac43-a0a3-42bf-bae8-14aa72fa7567)|  
|イベント グループを作成する|[PIXBeginEvent](http://msdn.microsoft.com/ja-jp/5f51fff7-f313-4558-965b-2a443653cd7b)|[PIXBeginEvent](http://msdn.microsoft.com/ja-jp/4ddb3311-b9b5-449a-bbfb-7634e0d56e87)|  
|イベント グループを終了する|[PIXEndEvent](http://msdn.microsoft.com/ja-jp/fb526bf2-c17d-4a2a-8665-3b577a0f7fba)|[PIXEndEvent](http://msdn.microsoft.com/ja-jp/a3cd34a9-9dd9-40e1-ae86-0214b25ff185)|  
|イベント マーカーを作成する|[PIXSetMarker](http://msdn.microsoft.com/ja-jp/0caf49ed-c99d-405e-89f4-0c887b8474ad)|[PIXSetMarker](http://msdn.microsoft.com/ja-jp/6610e5b9-a0c5-4236-b551-b6eb9fac64c1)|  
