...
## <a name="see-also"></a>関連項目
 <xref:System.OverflowException?displayProperty=fullName> [C# 演算子](/dotnet/csharp/language-reference/operators/index) [Checked と Unchecked](/dotnet/csharp/language-reference/keywords/checked-and-unchecked)