...
## <a name="see-also"></a>関連項目
 [/STACK (スタック割り当て)](/cpp/build/reference/stack-stack-allocations) [_resetstkoflw](/cpp/c-runtime-library/reference/resetstkoflw) [方法: ネイティブ ランタイム チェックを使用](../debugger/how-to-use-native-run-time-checks.md)