...
## <a name="see-also"></a>関連項目
 [移植性に関する警告](../code-quality/portability-warnings.md)[特定の .NET Framework のバージョンを対象とします。](../ide/targeting-a-specific-dotnet-framework-version.md)