...
|[CA1724: 型名は名前空間と同一にすることはできません](../code-quality/ca1724-type-names-should-not-match-namespaces.md)|型名は、.NET Framework クラス ライブラリで定義されている名前空間の名前と一致する必要があります。 この規則違反は、ライブラリの使いやすさを減らすことができます。|
