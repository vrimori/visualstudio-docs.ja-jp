...
-   MD5 ハッシュを使用、 [sha-2](/windows/desktop/SecCrypto/hash-and-signature-algorithms)ファミリ (例: <xref:System.Security.Cryptography.SHA512>、 <xref:System.Security.Cryptography.SHA384>、 <xref:System.Security.Cryptography.SHA256>)。
