...
## <a name="see-also"></a>関連項目
 <xref:System.EventArgs?displayProperty=fullName> <xref:System.Object?displayProperty=fullName> [処理と、イベントを発生させる](/dotnet/standard/events/index)