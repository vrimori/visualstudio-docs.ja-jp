...
警告 C26165: 関数 \<func\> でロック \<ロック\> の解放に失敗する可能性があります  
  
 警告 C26165 で警告の [C26115](../code-quality/c26115.md) に似ていますが、信頼レベルの低いものです。  たとえば、関数は、注釈のエラーが含まれる場合があります。  
  
## 使用例  
 次のコードでは、警告 C26165 を生成します。  
