...
作業項目トラッキング内からログの作業項目に機能を使用する[!INCLUDE[vsPreLong](../code-quality/includes/vsprelong_md.md)]です。 この機能を使用するプロジェクトがチーム プロジェクトの一部をする必要があります[!INCLUDE[esprfound](../code-quality/includes/esprfound_md.md)]です。  
