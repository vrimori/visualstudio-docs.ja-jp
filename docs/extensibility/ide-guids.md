...
<xref:Microsoft.VisualStudio.VSConstants>クラスは、次の表に示すように統合開発環境 (IDE) の一部の Guid を公開します</xref:Microsoft.VisualStudio.VSConstants>。  
...
## <a name="files-virtual-and-physical-folders-and-subprojects"></a>ファイル、仮想および物理のフォルダーおよびサブプロジェクト  
...
## <a name="command-sets-and-properties"></a>コマンド セットおよびプロパティ  
