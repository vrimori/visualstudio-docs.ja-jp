...
![VSSDK ビルド ツール](~/extensibility/media/vssdk-build-tools.png)
...
* 選択**の前提条件** タブをクリックし、キーを押して**新規** ボタンをクリックします。
  ...
  ![VSIX マニフェスト デザイナー](~/extensibility/media/vsix-manifest-designer.png)

* **追加新しい前提条件となる**ウィンドウが開きます。

  ![vsix の前提条件を追加します。](~/extensibility/media/add-vsix-prerequisite.png)
...
* 必要な場合は、バージョンを更新します。
  ...
  ![roslyn の前提条件を追加します。](~/extensibility/media/add-roslyn-prerequisite.png)
...
![外部プログラムを開始します。](~/extensibility/media/start-external-program.png)
...
![VSIX インストーラーは Visual Studio 2017](~/extensibility/media/vsixinstaller-vs-2017.png)
...
![vs のプロセスを実行します。](~/extensibility/media/vs-running-processes.png)
...
![vsixinstaller 前提条件がないです。](~/extensibility/media/vsixinstaller-missing-prerequisite.png)
