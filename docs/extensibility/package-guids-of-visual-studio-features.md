---
title: "Visual Studio の機能の Guid をパッケージ化 |Microsoft ドキュメント"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="package-guids-of-visual-studio-features"></a>Visual Studio の機能のパッケージの Guid
分離シェル アプリケーションの .pkgundef ファイルに次の Guid を使用して、特定のパッケージをアプリケーションから除外することができます。  
  
## <a name="package-guids"></a>パッケージの Guid  
  
|機能エリア|生のパッケージ名|パッケージ GUID|  
|------------------|----------------------|------------------|  
|コア IDE|パッケージを元に戻す|{1D76B2E0-F11B-11D2-AFC3-00105A9991EF}|  
||Visual Studio 環境のパッケージ|{DA9FB551-C724-11d0-AE1F-00A0C90FFFC3}|  
||Visual Studio のコマンドの定義パッケージ|{44E07B02-29A5-11D3-B882-00C04F79F802}|  
...
||Visual Studio 環境] メニューの [パッケージ|{715F10EB-9E99-11D2-BFC2-00C04F990235}|  
...
|クラスの概要|Class Outline Package|{21AF45B0 FFA5-11-D&0;-G63F-00A0C922E851}|  
...
|HTML エディター|Visual Studio HTM Editor Package|{1B437D20-F8FE-11D2-A6AE-00104BCC7269}|  
||Visual Web Developer HTML Source Editor Package|{BFCC0C3C-6F87-4285-A6C8-BB616061800D}|  
|CSS エディター|Visual Studio CSS Editing Package|{A764E895-518D-11d2-9A89-00C04F79EFC3}|  
|XML エディター|Visual Studio XML Editor Package|{87569308-4813-40A0-9CD0-D7A30838CA3F}|  
|Web ブラウザー|Visual Studio Web Browser Package|{E8B06F41-6D01-11D2-AA7D-00C04F990343}|  
||ブラウザーの機能の表示、web アプリケーション プロジェクトのファクトリ|{349C5851-65DF-11DA-9384-00065B846F21}|  
|バイナリ エディター|Visual Studio Binary Editor Package|{5B98C2C0-CD7B-11D0-92DF-00A0C9138C45}|  
|Windows フォーム デザイナー|Windows フォーム デザイナー ホスティングのパッケージ|{68939055-38E0-4D17-92CB-8909710D8178}|  
||Windows フォーム デザイナー パッケージ|{7494682B-37A0-11D2-A273-00C04F8EF4FF}|  
||Windows フォーム デザイナーのリソースのパッケージ|{7B5D447B-0B12-41EA-A84E-C822034422D4}|  
...
|データベース ツール|Visual Database Tools Package|{220A4C17-7E7C-4663-BBCC-5E607C6543CD}|  
...
|DSL のランタイム|CommonModelingPackage|{D1091694-EA72-4BDD-8918-78324CC25448}|  
||Microsoft.VisualStudio.TextTemplating|{A9696DE6-E209-414D-BBEC-A0506fb0E924}|  
|SourceSafe のサポート|Visual SourceSafe Provider Package|{AA8EB8CD-7A51-11D0-92C3-00A0C9138C45}|  
...
|コード スニペット|Visual Studio Code Snippets Package|{0B680757-2C29-4531-80FA-535A5178AA98}|  
|マネージ言語プロジェクトのサポート|Visual Studio コンポーネントの列挙子|{588205E0-66e0-11D3-8600-00C04F6123B3}|  
||Visual Studio Settings and Project Designers Package|{67909B06-91E9-4F3E-AB50-495046BE9A9A}|  
|テンプレートをエクスポートするには.|Export Template Package|{F1E4CFCA-4573-4345-8718-7BDE2b1F0BE8}|  
  
 その他の多くの機能は、それらを依存関係を取得するので、一部のパッケージを削除してくださいことはありません。 たとえば、"コア IDE"の下に表示されていることはありません削除してください。  
  
 一部の機能を完全に削除することはできません。 たとえば、パッケージを削除する登録を解除することはありません**クラス ビュー**とその関連するメニューのオプション、およびサービスです。 **クラス ビュー**ウィンドウはその他のキーの IDE 機能も提供 Visual Studio 環境パッケージによって提供されます。 削除する必要がある場合**クラス ビュー**を削除する必要がありますも**検索し、置換**、環境内**オプション**、ページ、**コマンド ウィンドウ**、および**出力**ウィンドウです。
