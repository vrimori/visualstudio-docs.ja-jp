...
||Visual Studio ディレクトリ一覧パッケージ|{5010C52F-44AB-4051-8CE1-D36C20D989B4}|  
||Visual Studio 共通 IDE パッケージ|{6E87CFAD-6C05-4ADF-9CD7-3B7943875B7C}|  
...
||Visual Web Developer プロジェクト システムのパッケージ|{39C9C826-8EF8-4079-8C95-428F5B1C323F}|  
...
|Web ブラウザー|Visual Studio Web ブラウザーのパッケージ|{E8B06F41-6D01-11D2-AA7D-00C04F990343}|  
||ブラウザーの機能の表示の web アプリケーション プロジェクト ファクトリ|{349C5851-65DF-11DA-9384-00065B846F21}|  
|バイナリ エディター|Visual Studio バイナリ エディター パッケージ|{5B98C2C0-CD7B-11D0-92DF-00A0C9138C45}|  
|Windows フォーム デザイナー|Windows フォーム デザイナー ホスティング パッケージ|{68939055-38E0-4D17-92CB-8909710D8178}|  
||Windows フォーム デザイナー パッケージ|{7494682B-37A0-11D2-A273-00C04F8EF4FF}|  
||Windows フォーム デザイナー リソース パッケージ|{7B5D447B-0B12-41EA-A84E-C822034422D4}|  
...
|データベース ツール|Visual データベース ツール パッケージ|{220A4C17-7E7C-4663-BBCC-5E607C6543CD}|  
||Visual Studio データベース ツール デザイナー|{EF828E39-70F5-4b8e-A3A0-4C0ECD28A69A}|  
...
||Visual Studio データ デザイナーの機能拡張パッケージ|{A8F602E2-40CE-4dAF-AE82-A457A91728B9}|  
...
||Visual Studio の設定とプロジェクト デザイナーのパッケージ|{67909B06-91E9-4F3E-AB50-495046BE9A9A}|  
|テンプレートをエクスポートしてください.|テンプレート パッケージをエクスポートします。|{F1E4CFCA-4573-4345-8718-7BDE2b1F0BE8}|  
  
 その他の多くの機能に依存関係がかかるために、一部のパッケージを削除してくださいことはありません。 たとえば、"コア IDE"の下に表示されていることはありません削除してください。  
  
 一部の機能は完全に削除することはできません。 たとえば、パッケージを削除する登録を解除することはありません**クラス ビュー**とその関連付けられたメニューのオプション、およびサービス。 **クラス ビュー**ウィンドウは、その他のキーの IDE 機能も提供 Visual Studio 環境パッケージによって提供されます。 削除する場合は**クラス ビュー**、削除する必要がありますも**検索し、置換**、環境**オプション**、ページ、**コマンド ウィンドウ**、および**出力**ウィンドウです。