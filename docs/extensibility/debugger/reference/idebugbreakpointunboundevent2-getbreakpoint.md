---
title: IDebugBreakpointUnboundEvent2::GetBreakpoint |Microsoft ドキュメント
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-sdk
...
#### <a name="parameters"></a>パラメーター  
 `ppBP`  
 [out]返します、 [IDebugBoundBreakpoint2](../../../extensibility/debugger/reference/idebugboundbreakpoint2.md)をバインド解除されました、ブレークポイントを表すオブジェクト。  
