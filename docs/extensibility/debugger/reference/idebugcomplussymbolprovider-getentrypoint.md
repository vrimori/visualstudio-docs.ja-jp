---
title: IDebugComPlusSymbolProvider::GetEntryPoint |Microsoft ドキュメント
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-sdk
...
#### <a name="parameters"></a>パラメーター  
 ...
 `ppAddress`  
 [out]によって表されるエントリ ポイントを返します、 [IDebugAddress](../../../extensibility/debugger/reference/idebugaddress.md)インターフェイスです。  
