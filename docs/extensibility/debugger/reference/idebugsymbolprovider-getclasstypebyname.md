---
title: IDebugSymbolProvider::GetClassTypeByName |Microsoft ドキュメント
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-sdk
...
#### <a name="parameters"></a>パラメーター  
 ...
 `ppField`  
 [out]によって表されるクラス型を返します、 [IDebugClassField](../../../extensibility/debugger/reference/idebugclassfield.md)インターフェイスです。  
