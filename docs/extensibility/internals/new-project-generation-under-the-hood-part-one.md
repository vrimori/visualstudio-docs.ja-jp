...
## \[新しいプロジェクト\] ダイアログ ボックス  
 ...
 ![&#91;新しいプロジェクト&#93; ダイアログ ボックス](~/docs/extensibility/internals/media/newproject.gif "NewProject")  
...
#### プロジェクトの種類の子ノードおよび .vstdir ファイル  
 ...
 ![プロジェクトの種類](~/docs/extensibility/internals/media/projecttypes.png "ProjectTypes")  
  
 対応する ProjectTemplates フォルダーは、次のようになります。  
  
 ![プロジェクト テンプレート](~/docs/extensibility/internals/media/projecttemplates.png "ProjectTemplates")  
