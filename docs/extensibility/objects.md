...
次の内容については、中核となるテキスト エディターのインスタンスの作成に使用されるオブジェクトについて説明します。  
  
## このセクションの内容  
 [VSCodeWindow オブジェクト](../extensibility/vscodewindow-object.md)  
 コード ウィンドウのオブジェクト、1 つ以上のテキスト ビューを囲むことができ、特殊なドキュメント ウィンドウについて説明します。  
  
 [VSCodeWindowManager オブジェクト](../extensibility/vscodewindowmanager-object.md)  
 言語サービスによって実装され、表示要素を管理するため、コード ウィンドウ マネージャー オブジェクトについて説明します。  
