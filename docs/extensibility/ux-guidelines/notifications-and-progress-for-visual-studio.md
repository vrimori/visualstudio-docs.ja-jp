...
####  <a name="a-namebkmkmodalerrormessagedialogsa-modal-error-message-dialogs"></a><a name="BKMK_ModalErrorMessageDialogs"></a>モーダル エラー メッセージ ダイアログ ボックス  
 ...
 ![モーダル エラー メッセージ](~/docs/extensibility/ux-guidelines/media/0901-01_modalerrormessage.png "0901&01;_ModalErrorMessage")  
...
####  <a name="a-namebkmkidestatusbara-ide-status-bar"></a><a name="BKMK_IDEStatusBar"></a>IDE のステータス バー  
 ...
 ![IDE ステータス バーの色の変更](~/docs/extensibility/ux-guidelines/media/0901-02_idestatusbar.png "0901&02;_IDEStatusBar")  
...
####  <a name="a-namebkmkembeddedinfobara-embedded-infobar"></a><a name="BKMK_EmbeddedInfobar"></a>埋め込まれた情報バー  
 ...
 ![情報バーが埋め込まれている](~/docs/extensibility/ux-guidelines/media/0901-03_embeddedinfobar.png "0901&03;_EmbeddedInfobar")  
...
####  <a name="a-namebkmkvsnotificationstoolwindowa-visual-studio-notifications-window"></a><a name="BKMK_VSNotificationsToolWindow"></a>Visual Studio の通知ウィンドウ  
 ...
 ![Visual Studio の通知ウィンドウ](~/docs/extensibility/ux-guidelines/media/0901-06_vsnotificationswindow.png "0901&06;_VSNotificationsWindow")  
...
####  <a name="a-namebkmkerrorlista-error-list"></a><a name="BKMK_ErrorList"></a>エラー一覧  
 ...
 ![エラー一覧](~/docs/extensibility/ux-guidelines/media/0901-08_errorlist.png "0901&08;_ErrorList")  
...
####  <a name="a-namebkmkembeddedstatusbarsa-embedded-status-bars"></a><a name="BKMK_EmbeddedStatusBars"></a>埋め込まれたステータス バー  
 ...
 ![埋め込まれたステータス バー](~/docs/extensibility/ux-guidelines/media/0901-09_embeddedstatusbar.png "0901&09;_EmbeddedStatusBar")  
...
####  <a name="a-namebkmknotificationbubblesa-notification-bubbles"></a><a name="BKMK_NotificationBubbles"></a>通知バブル  
 ...
 ![通知バブル](~/docs/extensibility/ux-guidelines/media/0901-07_notificationbubbles.png "0901&07;_NotificationBubbles")  
...
##### <a name="indeterminate"></a>不確定  
 ![不確定な進行状況バー](~/docs/extensibility/ux-guidelines/media/0901-04_indeterminate.png "0901&04;_Indeterminate")  
...
##### <a name="determinate"></a>不確定であります。  
 ![確定した進行状況バー](~/docs/extensibility/ux-guidelines/media/0901-05_determinate.png "0901&05;_Determinate")  
...
##### <a name="ants-animated-horizontal-dots"></a>Ants (水平方向のドットをアニメーション化された)  
 ![進行状況 ant](~/docs/extensibility/ux-guidelines/media/0903-01_ants.png "0903&01;_Ants")  
  
 「アリ、」水平方向のアニメーションのドットは不確定なラウンドト リップ サーバー プロセスの視覚的な参照を提供します。  
  
##### <a name="spinner-progress-ring"></a>スピン ボックス (進行状況リング)  
 ![進行状況スピナー](~/docs/extensibility/ux-guidelines/media/0903-02_spinner.png "0903&02;_Spinner")  
...
##### <a name="status-bar"></a>ステータス バー  
 ...
 ![進行状況バー付きのステータス バー](~/docs/extensibility/ux-guidelines/media/0903-03_statusbarprogressbar.png "0903&03;_StatusBarProgressBar")  
  
 **進行状況バー付きのステータス バー**  
  
 ![メッセージング付きのステータス バー](~/docs/extensibility/ux-guidelines/media/0903-04_statusbarmessage.png "0903&04;_StatusBarMessage")  
...
##### <a name="infobar"></a>情報バー  
 ...
 ![進行状況バーとメッセージング付きの情報バー](~/docs/extensibility/ux-guidelines/media/0903-05_infobar.png "0903&05;_InfoBar")  
  
 **進行状況バーと説明テキストを含むページ**  
  
 ![ウィンドウ内の情報バー](~/docs/extensibility/ux-guidelines/media/0903-06_infobarinwindow.png "0903&06;_InfoBarInWindow")  
...
##### <a name="inline"></a>インライン  
 ...
 ![インラインの進行状況スピナー](~/docs/extensibility/ux-guidelines/media/0903-07_inlinespinner.png "0903&07;_InlineSpinner")  
  
 **スピン ボタンの説明テキストと組み合わせる**  
  
 ![インラインの積み上げ進行状況バー](~/docs/extensibility/ux-guidelines/media/0903-08_inlinestackedprogress.png "0903&08;_InlineStackedProgress")  
  
 **確定した積み上げ進行状況バー**  
  
 ![インラインの進行状況メッセージング](~/docs/extensibility/ux-guidelines/media/0903-09_inlinetext.png "0903&09;_InlineText")  
...
##### <a name="tool-windows"></a>ツール ウィンドウ  
 ...
 ![グローバルで不確定な進行状況バー](~/docs/extensibility/ux-guidelines/media/0903-23_globalindeterminate.png "0903&23;_GlobalIndeterminate")  
...
##### <a name="dialogs"></a>ダイアログ  
 ...
 ![複数の種類の進行状況インジケーターを含むダイアログ](~/docs/extensibility/ux-guidelines/media/0903-11_dialog.png "0903&11;_Dialog")  
  
 **同時実行プロセスと、複数の種類の進行状況インジケーターの visual Studio ダイアログ**  
  
 ![進行状況ローダーとメッセージング付きのダイアログ](~/docs/extensibility/ux-guidelines/media/0903-12_dialog2.png "0903&12;_Dialog2")  
...
##### <a name="document-well"></a>適切に文書化します。  
 ...
 ![進行状況もドキュメントのメッセージング](~/docs/extensibility/ux-guidelines/media/0903-13_documentwell.png "0903&13;_DocumentWell")  
...
##### <a name="output-window"></a>[出力] ウィンドウ  
 ...
 ![[出力] ウィンドウでのメッセージングの進行状況](~/docs/extensibility/ux-guidelines/media/0903-14_outputwindow.png "0903&14;_OutputWindow")  
...
### <a name="overview"></a>概要  
 ...
 ![情報バー](~/docs/extensibility/ux-guidelines/media/0904-01_infobar.png "0904&01;_Infobar")  
...
```  
 ...
 ![ハイパーリンクを含むページ](~/docs/extensibility/ux-guidelines/media/0904-02_infobarhyperlink.png "0904&02;_InfobarHyperlink")  
...
### <a name="field-validation"></a>フィールドの検証  
 ...
 ![検証 (空白) をフィールド](~/docs/extensibility/ux-guidelines/media/0905-01_fieldvalidation.png "0905&01;_FieldValidation")  
 ...
 ![「必須」のラベルを持つ検証をフィールド](~/docs/extensibility/ux-guidelines/media/0905-02_fieldvalidationrequired.png "0905&02;_FieldValidationRequired")  
 ...
 ![検証のレイアウトの仕様をフィールド](~/docs/extensibility/ux-guidelines/media/0905-03_layoutspecs.png "0905&03;_LayoutSpecs")  
...
#### <a name="acceptable-variations-for-icon-location"></a>アイコンの場所で使用可能なバリエーション  
 ...
 ![アイコンの場所の場所の適切な](~/docs/extensibility/ux-guidelines/media/0905-04_iconlocation.png "0905&04;_IconLocation")  
...
#### <a name="validation-requiring-a-round-trip-to-a-server-or-network-connection"></a>サーバーまたはネットワーク接続へのラウンド トリップを必要とする検証  
 ...
 ![サーバーへのラウンド トリップに関連する検証](~/docs/extensibility/ux-guidelines/media/0905-05_roundtrip.png "0905&05;_RoundTrip")  
...
#### <a name="in-place-warning-text"></a>インプレース警告テキスト  
 ...
 ![インプレース警告](~/docs/extensibility/ux-guidelines/media/0905-06_inplacewarning.png "0905&06;_InPlaceWarning")  
...
#### <a name="watermarks"></a>透かし  
 ...
 ![透かし](~/docs/extensibility/ux-guidelines/media/0905-07_watermark.png "0905&07;_Watermark")  
