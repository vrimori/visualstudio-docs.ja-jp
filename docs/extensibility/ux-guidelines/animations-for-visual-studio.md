...
![X と Y 位置変更アニメーション](~/docs/extensibility/ux-guidelines/media/1202-f_xypositionchange.png "1202-f_XYPositionChange")<br />X と Y 位置変更アニメーション  
...
![UI 要素の回転アニメーション](~/docs/extensibility/ux-guidelines/media/1202-g_rotate.png "1202-g_Rotate")<br />UI 要素の回転アニメーション  
