---
title: 従来のワークフロー プロジェクトを作成 |Microsoft ドキュメント
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
