...
このセクションには、Windows ワークフロー デザイナーの状況依存のヘルプ トピックが含まれています。 Visual Studio 2010 で作業しているときにユーザー インターフェイスからのこれらのトピックするアクセス キーを押して**F1**ワークフロー デザイナー ダイアログ ボックスが開いているとき。
