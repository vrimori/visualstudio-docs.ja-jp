---
title: "スイッチ&lt;T&gt;アクティビティ デザイナー |Microsoft ドキュメント"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
 ...
 **Switch < T\>** 作成および構成するアクティビティ デザイナーを使用、<xref:System.Activities.Statements.Switch%601>内のアクティビティ、[!INCLUDE[wfd1](../workflow-designer/includes/wfd1_md.md)]です。  
 ...
 **スイッチ\<T >**アクティビティ デザイナーは含まれて、**制御フロー**のカテゴリ、**ツールボックス**、 をクリックしてアクセスされる**ツールボックス**タブで、 [!INCLUDE[wfd2](../workflow-designer/includes/wfd2_md.md)] (または、選択**ツールバー**から、**ビュー**メニューのまたは CTRL + ALT + X です)。ドロップすた後、 [!INCLUDE[wfd2](../workflow-designer/includes/wfd2_md.md)]、表示、**タイプの選択**ユーザーが、ジェネリック型を指定できるようにするためのダイアログ*T*で使用される<xref:System.Activities.Statements.Switch%601>アクティビティ。 既定値は**Int32**です。 ジェネリック型*T*が選択されている、 **Switch < T\>** デザイナーがワークフロー デザイナーに追加します。  
