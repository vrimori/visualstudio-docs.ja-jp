...
description: ダウンロード キャッシュ、共有コンポーネント、SDK、ツールの場所を異なるドライブに変更することによって、システム ドライブのインストール 占有領域を減らす方法について説明します。
ms.date: 05/07/2018
...
**15.7 の新機能**: ダウンロード キャッシュ、共有コンポーネント、SDK、ツールを異なるドライブに移動することによって、システム ドライブのインストール 占有領域を減らすことができます。
