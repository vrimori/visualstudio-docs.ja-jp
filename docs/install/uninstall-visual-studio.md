...
2.  クリックしてインストーラーを起動し、![詳細アイコン](~/docs/install/media/vs2017uninstall-UninstallIcon.png "オプション アイコンを選択") アイコンをクリックして、**[アンインストール]** をクリックします。  

     ![Visual Studio 2017 の変更 (変更、起動、修復、またはアンインストール)](~/docs/install/media/vs2017-uninstall.PNG "Visual Studio 2017 の修復またはアンインストール")  

3.  **[OK]** をクリックして選択を確定します。

     ![Visual Studio 2017 の変更 (製品のアンインストール)](~/docs/install/media/vs2017-uninstall-confirm.PNG "Visual Studio 2017 のアンインストールを確定")  
