---
title: "チュートリアル: SharePoint のサイト列、コンテンツ タイプ、およびリストの作成 | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
14. **\[プロパティ\]** の一覧で、**\[並べ替えとグループ化\]** のプロパティを選択し、**\[並べ替えとグループ化\]** ダイアログ ボックスを ![省略記号アイコン](../sharepoint/media/ellipsisicon.png "省略記号アイコン") 表示するには、…ボタンをクリックします。  
