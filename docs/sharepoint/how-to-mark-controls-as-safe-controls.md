...
3.  Web パーツの **\[安全なコントロール エントリ\]** プロパティに 2 つのエントリを追加します。  これを行うには、**\[プロパティ\]** ウィンドウの **\[安全なコントロール エントリ\]** のプロパティの横にある省略記号 \(![ASP.NET モバイル デザイナー楕円](~/docs/sharepoint/media/mwellipsis.gif "ASP.NET モバイル デザイナー楕円")\) ボタンをクリックします。  
...
8.  **\[既存のアセンブリの追加\]** ダイアログ ボックスで、**\[ソース パス\]** の横にある省略記号 \(![ASP.NET モバイル デザイナー楕円](~/docs/sharepoint/media/mwellipsis.gif "ASP.NET モバイル デザイナー楕円")\) ボタンをクリックします。  
