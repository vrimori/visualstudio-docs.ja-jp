...
---
# <a name="associating-custom-data-with-sharepoint-tools-extensions"></a>カスタム データの SharePoint ツールの拡張機能への関連付け
...
## <a name="adding-and-retrieving-custom-data"></a>追加して、カスタム データを取得します。  
