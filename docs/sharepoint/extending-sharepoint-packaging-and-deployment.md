...
## <a name="run-code-when-a-sharepoint-solution-is-deployed-or-retracted"></a>SharePoint ソリューションの配置または取り消すときに、コードを実行します。
...
## <a name="run-command-line-operations-before-or-after-a-project-is-deployed"></a>プロジェクトを配置した後または前に、コマンドライン操作を実行します。
