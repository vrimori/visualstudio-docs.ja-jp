...
ms.locfileid: "34767210"
---
# <a name="how-to-add-and-remove-mapped-folders"></a>方法: 追加およびマップされたフォルダーを削除します。
...
7.  **ソリューション エクスプ ローラー**、プロジェクト ノードを選択し、次に、メニュー バーで、次のように選択します**プロジェクト** > **SharePoint のマップされたフォルダーの追加**、を表示するには。**SharePoint のマップされたフォルダーを追加** ダイアログ ボックス。  
...
## <a name="rename-or-remove-mapped-folders"></a>名前を変更またはマップされたフォルダーを削除します。  
