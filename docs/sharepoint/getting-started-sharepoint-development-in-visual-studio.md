---
title: はじめに (Visual Studio での SharePoint 開発) |Microsoft ドキュメント
ms.custom: ''
ms.date: 02/02/2017
ms.technology:
- office-development
...
ms.locfileid: "34766800"
---
# <a name="get-started-sharepoint-development-in-visual-studio"></a>開始 (での SharePoint 開発 Visual Studio) の取得します。
