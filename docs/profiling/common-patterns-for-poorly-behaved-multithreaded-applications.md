...
## <a name="lock-contention-and-serialized-execution"></a>ロック競合とシリアル化実行  
 ![シリアル化実行でのロック競合の結果](~/docs/profiling/media/lockcontention_serialized.png "LockContention_Serialized")  
 ...
 ![ロック競合](~/docs/profiling/media/lockcontention_2.png "LockContention_2")  
  
## <a name="uneven-workload-distribution"></a>不均一なワークロード分散  
 ![不均一なワークロード](~/docs/profiling/media/unevenworkload_1.png "UnevenWorkLoad_1")  
 ...
 ![不均一なワークロード](~/docs/profiling/media/unevenworkload_2.png "UnevenWorkload_2")  
  
## <a name="oversubscription"></a>オーバーサブスクリプション  
 ![オーバーサブスクリプション](~/docs/profiling/media/oversubscription.png "Oversubscription")  
...
## <a name="inefficient-io"></a>非効率的な I/O  
 ![非効率な I&#47;O](~/docs/profiling/media/inefficient_io.png "Inefficient_IO")  
...
## <a name="lock-convoys"></a>ロック コンボイ  
 ![ロック コンボイ](~/docs/profiling/media/lock_convoys.png "Lock_Convoys")  
