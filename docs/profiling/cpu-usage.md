...
1.  Visual Studio で、ソリューション構成を [ **リリース** ] に設定して配置ターゲットを選択します。  
     ...
     ![リリースとローカル コンピューターの選択](~/docs/profiling/media/cpuuse_selectreleaselocalmachine.png "CPUUSE_SelectReleaseLocalMachine")  
...
3.  [ **CPU 使用率** ]、[ **開始**] を選択します。  
     ...
     ![CPU 使用率の選択](~/docs/profiling/media/cpuuse_lib_choosecpuusage.png "CPUUSE_LIB_ChooseCpuUsage")  
