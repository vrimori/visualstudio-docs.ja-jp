...
## <a name="span-category"></a>スパン カテゴリ  
 ...
 ![異なるカテゴリの 5 つの範囲](~/docs/profiling/media/cvmarkerspancategory.png "CVMarkerSpanCategory")  
最初の 5 つのスパン カテゴリの色  
...
## <a name="span-aggregation-markers"></a>スパンの集約マーカー  
 ...
 ![同時実行ビジュアライザーの集約スパン マーカー](~/docs/profiling/media/cvmarkerspanaggregate.png "CVMarkerSpanAggregate")  
スパン集約マーカー  
