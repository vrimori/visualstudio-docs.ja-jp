...
## <a name="how-to-investigate-a-warning"></a>警告の調査方法  
 ...
 .NET Framework アプリケーションでは、共通言語ランタイムによって、マネージド ヒープの合計サイズが、プロセス アドレス空間のプライベート領域部分の最大サイズの半分よりわずかに小さいサイズに制限されます。 32 ビット コンピューター上で実行している 32 ビット プロセスの場合、プロセスのアドレス空間のプライベート領域の上限は 2 GB です。 マネージド ヒープの合計サイズがその既定の制限値に近づくと、マネージド メモリのオーバーヘッドが増加し、アプリケーションのパフォーマンスが低下する可能性があります。  
