...
|タスク|関連するコンテンツ|
|----------|---------------------|
|**Windows 8 以降向けの手法**|[Windows 8 および Windows Server 2012 アプリケーションのパフォーマンス ツール](../profiling/performance-tools-on-windows-8-and-windows-server-2012-applications.md)|
