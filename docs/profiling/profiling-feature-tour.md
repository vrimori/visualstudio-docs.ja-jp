...
![診断ツール ウィンドウ](~/docs/profiling/media/prof-tour-diagnostic-tools.png "Diagnostic Tools")

デバッグ中、**[診断ツール]** ウィンドウを利用し、CPU とメモリの使用状況を分析できます。また、パフォーマンス関連情報を示すイベントを閲覧できます。

![診断ツールの概要ビュー](~/docs/profiling/media/prof-tour-cpu-and-memory-graph.gif "Diagnostic Tools Summary")
...
![診断ツールの CPU 使用率を有効にする](~/docs/profiling/media/prof-tour-enable-cpu-profiling.png "Diagnostic Tools Enable CPU Usage")
...
![診断ツールの CPU 使用率ビュー](~/docs/profiling/media/prof-tour-cpu-usage.png "Diagnostic Tools CPU Usage")
...
![診断ツールの呼び出し元/呼び出し先 "バタフライ" ビュー](~/docs/profiling/media/prof-tour-cpu-usage-caller-callee.png "Diagnostic Tools Caller Callee View")
...
![診断ツールのイベントビュー](~/docs/profiling/media/prof-tour-events.png "Diagnostic Tools View Events")
...
![プロファイルのパフォーマンスのヒント](~/docs/profiling/media/prof-tour-perf-tips.png "プロファイルのパフォーマンスのヒント")
...
![診断ツールで UI 分析イベントを表示する](~/docs/profiling/media/prof-tour-ui-analysis.png "Diagnostic Tools View UI Analysis Events")
...
![パフォーマンス プロファイラー](~/docs/profiling/media/prof-tour-performance-profiler.png "パフォーマンス プロファイラー")
...
![アプリケーションのタイムラインのプロファイリング ツール](~/docs/profiling/media/prof-tour-application-timeline.gif "Profiling Tour Application Timeline")
...
![GPU 使用率プロファイリング ツール](~/docs/profiling/media/prof-tour-gpu-usage.png "Diag GPU Usage")
...
![ネットワーク使用率プロファイリング ツール](~/docs/profiling/media/prof-tour-network-usage.png "Diag Network Usage")

概要ビューで操作を選択すると、詳細が表示されます。

![ネットワーク使用率ツールの詳細情報](~/docs/profiling/media/prof-tour-network-usage-details.png "Diag Network Usage Details")
...
![パフォーマンス エクスプローラー ツール](~/docs/profiling/media/prof-tour-performance-explorer.png "Performance Explorer")
