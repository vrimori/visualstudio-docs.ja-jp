...
## <a name="design-surface"></a>デザイン画面
 ...
 デザイン サーフェイスが空白の場合、XML エディター、 **XML スキーマ エクスプ ローラー**、および透かしが表示されます。 *透かし*XSD デザイナーのすべてのビューへのリンクの一覧を示します。 スキーマ セットにエラーがある場合、一覧の最後に "スキーマ セット内のエラーを表示および修正するには、エラー一覧を使用します" というテキストが表示されます。
...
## <a name="xml-editor-integration"></a>XML エディターとの統合
 ...
 間を気軽に切り替えることができます、 **XSD デザイナー**と XML エディター コンテキスト メニューを使用します。
