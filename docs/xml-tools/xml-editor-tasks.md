---
title: "XML エディターのタスク |Microsoft ドキュメント"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 [方法: XML スニペットを使用する](../xml-tools/how-to-use-xml-snippets.md)です。  
