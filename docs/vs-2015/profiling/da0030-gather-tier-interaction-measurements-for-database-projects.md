...
このトピックの最新バージョンをご覧[DA0030: データベース プロジェクトの階層の相互作用を収集測定](https://docs.microsoft.com/visualstudio/profiling/da0030-gather-tier-interaction-measurements-for-database-projects)します。  
