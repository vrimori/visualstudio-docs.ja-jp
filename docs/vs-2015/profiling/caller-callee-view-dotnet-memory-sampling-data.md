...
ms.locfileid: "47537799"
---
# <a name="callercallee-view---net-memory-sampling-data"></a>呼び出し元/呼び出し先ビュー - .NET メモリ サンプリング データ
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[呼び出し元/呼び出し先ビュー - .NET メモリ サンプリング データ](https://docs.microsoft.com/visualstudio/profiling/caller-callee-view-dotnet-memory-sampling-data)します。  
