...
ms.locfileid: "47537197"
---
# <a name="understanding-performance-collection-methods"></a>パフォーマンス収集方法について
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[パフォーマンス収集方法について](https://docs.microsoft.com/visualstudio/profiling/understanding-performance-collection-methods)します。  
