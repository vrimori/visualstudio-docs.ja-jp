...
ms.locfileid: "47545459"
---
# <a name="javascript-memory"></a>[JavaScript メモリ]
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[UWP アプリで JavaScript メモリの使用量を分析](https://docs.microsoft.com/visualstudio/profiling/javascript-memory)します。  
...
-   ユーザーが新しいページに移動した後も誤ってメモリに保持されているオブジェクトを検索します。これは、一般的なメモリの問題の原因です。 例えば:  
