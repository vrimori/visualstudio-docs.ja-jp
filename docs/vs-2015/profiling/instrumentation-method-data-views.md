...
ms.locfileid: "47538710"
---
# <a name="instrumentation-method-data-views"></a>インストルメンテーション メソッドのデータ ビュー
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[インストルメンテーション メソッドのデータ ビュー](https://docs.microsoft.com/visualstudio/profiling/instrumentation-method-data-views)します。  
