...
## <a name="see-also"></a>関連項目  
 ...
 [< PAVE_OVER > 方法: プロファイリング マークを構成](http://msdn.microsoft.com/library/65a23880-e5e8-4d5a-82b3-6498b9ef8975)   
 [< PAVE_OVER > 方法: Profiler のデータ ファイルにマークを挿入](http://msdn.microsoft.com/library/856bfc81-a60f-42e5-a9bc-71b986c1e09d)   
