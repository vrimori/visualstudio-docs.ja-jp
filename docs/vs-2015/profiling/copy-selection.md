...
ms.author: mikejo
manager: ghogen
ms.openlocfilehash: c44cf7574444d412483d49f2a25b5633fea95d89
ms.sourcegitcommit: 55f7ce2d5d2e458e35c45787f1935b237ee5c9f8
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 08/22/2018
ms.locfileid: "47548536"
---
# <a name="copy-selection"></a>選択範囲のコピー
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[選択範囲のコピー](https://docs.microsoft.com/visualstudio/profiling/copy-selection)します。  
