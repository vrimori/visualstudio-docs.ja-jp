...
ms.locfileid: "47548815"
---
# <a name="modules-view---net-memory-instrumentation-data"></a>モジュール ビュー - .NET メモリ インストルメンテーション データ
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[モジュール ビュー - .NET メモリ インストルメンテーション データ](https://docs.microsoft.com/visualstudio/profiling/modules-view-dotnet-memory-instrumentation-data)します。  
