...
ms.locfileid: "47549155"
---
# <a name="modules-view---instrumentation-data"></a>モジュール ビュー - インストルメンテーション データ
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[モジュール ビュー - インストルメンテーション データ](https://docs.microsoft.com/visualstudio/profiling/modules-view-instrumentation-data)します。  
