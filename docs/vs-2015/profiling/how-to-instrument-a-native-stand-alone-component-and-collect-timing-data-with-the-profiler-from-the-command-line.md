...
このトピックの最新バージョンをご覧[方法: スタンドアロンのネイティブ コンポーネントをインストルメントし、コマンドラインから、Profiler のタイミング データを収集](https://docs.microsoft.com/visualstudio/profiling/how-to-instrument-a-native-stand-alone-component-and-collect-timing-data-with-the-profiler-from-the-command-line)します。  
