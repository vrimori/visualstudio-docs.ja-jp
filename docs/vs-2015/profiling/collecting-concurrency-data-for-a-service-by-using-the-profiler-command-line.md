...
このトピックの最新バージョンをご覧[Profiler のコマンドラインを使用してサービスの同時実行データを収集する](https://docs.microsoft.com/visualstudio/profiling/collecting-concurrency-data-for-a-service-by-using-the-profiler-command-line)します。  
