...
ms.locfileid: "47539624"
---
# <a name="guids-and-ids-of-visual-studio-menus"></a>Visual Studio メニューの GUID および ID
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[Guid と Visual Studio メニューの Id の](https://docs.microsoft.com/visualstudio/extensibility/internals/guids-and-ids-of-visual-studio-menus)します。  
