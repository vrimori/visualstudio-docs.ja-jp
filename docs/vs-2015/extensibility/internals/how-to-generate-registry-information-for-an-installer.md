...
ms.locfileid: "47545170"
---
# <a name="how-to-generate-registry-information-for-an-installer"></a>方法: インストーラーのレジストリ情報の生成
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[方法: インストーラー用のレジストリ情報の生成](https://docs.microsoft.com/visualstudio/extensibility/internals/how-to-generate-registry-information-for-an-installer)します。  
