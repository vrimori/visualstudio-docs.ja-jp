...
このトピックの最新バージョンをご覧[公開一覧のシンボル提供オブジェクト マネージャーに](https://docs.microsoft.com/visualstudio/extensibility/internals/how-to-expose-lists-of-symbols-provided-by-the-library-to-the-object-manager)します。  
