...
このトピックの最新バージョンをご覧[言語サービスでのアウトラインのサポートの提供](https://docs.microsoft.com/visualstudio/extensibility/internals/how-to-provide-expanded-outlining-support-in-a-legacy-language-service)します。  
