...
このトピックの最新バージョンをご覧[のインストールされているコード スニペットの一覧 (レガシ) を取得する](https://docs.microsoft.com/visualstudio/extensibility/internals/walkthrough-getting-a-list-of-installed-code-snippets-legacy-implementation)します。  
