...
ms.locfileid: "47544512"
---
# <a name="vsct-compiler-command-line-flags"></a>VSCT コンパイラのコマンドライン フラグ
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[VSCT コンパイラのコマンド ライン フラグ](https://docs.microsoft.com/visualstudio/extensibility/internals/vsct-compiler-command-line-flags)します。  
