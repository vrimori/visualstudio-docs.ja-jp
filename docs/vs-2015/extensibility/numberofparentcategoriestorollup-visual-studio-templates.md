...
このトピックの最新バージョンをご覧[NumberOfParentCategoriesToRollUp (Visual Studio テンプレート)](https://docs.microsoft.com/visualstudio/extensibility/numberofparentcategoriestorollup-visual-studio-templates)します。  
