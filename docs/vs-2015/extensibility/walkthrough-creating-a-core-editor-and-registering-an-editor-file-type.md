...
このトピックの最新バージョンをご覧[コア エディターを作成してエディター ファイルの種類を登録する](https://docs.microsoft.com/visualstudio/extensibility/walkthrough-creating-a-core-editor-and-registering-an-editor-file-type)します。  
