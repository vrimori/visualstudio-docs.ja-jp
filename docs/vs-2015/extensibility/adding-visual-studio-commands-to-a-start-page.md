...
ms.locfileid: "47533513"
---
# <a name="adding-visual-studio-commands-to-a-start-page"></a>Visual Studio コマンドのスタート ページへの追加
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[スタート ページを Visual Studio のコマンドを追加する](https://docs.microsoft.com/visualstudio/extensibility/adding-visual-studio-commands-to-a-start-page)します。  
