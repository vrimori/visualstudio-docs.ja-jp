...
ms.locfileid: "47534877"
---
# <a name="extending-and-customizing-tool-windows"></a>ツール ウィンドウの拡張とカスタマイズ
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[拡張とカスタマイズ ツール Windows](https://docs.microsoft.com/visualstudio/extensibility/extending-and-customizing-tool-windows)します。  
