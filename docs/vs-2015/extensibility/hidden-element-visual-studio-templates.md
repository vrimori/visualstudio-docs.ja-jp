...
ms.locfileid: "47533260"
---
# <a name="hidden-element-visual-studio-templates"></a>Hidden 要素 (Visual Studio Templates)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[非表示要素 (Visual Studio テンプレート)](https://docs.microsoft.com/visualstudio/extensibility/hidden-element-visual-studio-templates)します。  
