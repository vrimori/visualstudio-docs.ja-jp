...
このトピックの最新バージョンをご覧[IDebugGenericParamField::GetFlags](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebuggenericparamfield-getflags)します。  
