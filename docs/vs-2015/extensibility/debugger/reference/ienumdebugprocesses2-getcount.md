...
ms.locfileid: "47533782"
---
# <a name="ienumdebugprocesses2getcount"></a>IEnumDebugProcesses2::GetCount
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[IEnumDebugProcesses2::GetCount](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugprocesses2-getcount)します。  
