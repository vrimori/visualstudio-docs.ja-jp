...
ms.locfileid: "47534386"
---
# <a name="idebuggenericparamfieldgetowner"></a>IDebugGenericParamField::GetOwner
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[IDebugGenericParamField::GetOwner](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebuggenericparamfield-getowner)します。  
