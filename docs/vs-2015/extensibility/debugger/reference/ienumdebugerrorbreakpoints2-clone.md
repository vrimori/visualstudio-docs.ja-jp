...
このトピックの最新バージョンをご覧[IEnumDebugErrorBreakpoints2::Clone](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugerrorbreakpoints2-clone)します。  
