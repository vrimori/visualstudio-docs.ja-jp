...
このトピックの最新バージョンをご覧[IDebugPropertyField::GetPropertyGetter](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebugpropertyfield-getpropertygetter)します。  
