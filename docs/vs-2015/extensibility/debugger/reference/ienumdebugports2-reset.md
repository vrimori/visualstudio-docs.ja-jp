...
ms.locfileid: "47533375"
---
# <a name="ienumdebugports2reset"></a>IEnumDebugPorts2::Reset
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[IEnumDebugPorts2::Reset](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugports2-reset)します。  
