...
ms.locfileid: "47538653"
---
# <a name="ienumcodepaths2next"></a>IEnumCodePaths2::Next
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[IEnumCodePaths2::Next](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumcodepaths2-next)します。  
