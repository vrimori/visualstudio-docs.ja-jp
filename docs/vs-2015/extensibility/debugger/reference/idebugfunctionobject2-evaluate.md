...
このトピックの最新バージョンをご覧[IDebugFunctionObject2::Evaluate](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebugfunctionobject2-evaluate)します。  
