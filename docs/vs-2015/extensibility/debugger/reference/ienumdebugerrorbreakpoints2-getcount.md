...
このトピックの最新バージョンをご覧[IEnumDebugErrorBreakpoints2::GetCount](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugerrorbreakpoints2-getcount)します。  
