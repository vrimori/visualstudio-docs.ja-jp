...
このトピックの最新バージョンをご覧[IDebugComPlusSymbolProvider::IsFunctionDeleted](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebugcomplussymbolprovider-isfunctiondeleted)します。  
