...
このトピックの最新バージョンをご覧[PreviewImage 要素 (Visual Studio テンプレート)](https://docs.microsoft.com/visualstudio/extensibility/previewimage-element-visual-studio-templates)します。  
