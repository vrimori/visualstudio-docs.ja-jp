...
2.  AssemblyInfo.cs ファイルのコピー、**プロパティ**フォルダーを**Projects\SimpleProject**フォルダー。  
...
6.  **プロパティ**ウィンドウで、設定、**ビルド アクション**AssemblyInfo.cs、Program.cs、SimpleProject.ico、およびに SimpleProject.myproj の**コンテンツ**、し、そのの設定**VSIX に含める**プロパティ**True**します。  
