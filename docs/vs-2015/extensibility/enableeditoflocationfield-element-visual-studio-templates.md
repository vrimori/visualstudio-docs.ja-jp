...
このトピックの最新バージョンをご覧[EnableEditOfLocationField 要素 (Visual Studio テンプレート)](https://docs.microsoft.com/visualstudio/extensibility/enableeditoflocationfield-element-visual-studio-templates)します。  
