...
このトピックの最新バージョンをご覧[PromptForSaveOnCreation 要素 (Visual Studio テンプレート)](https://docs.microsoft.com/visualstudio/extensibility/promptforsaveoncreation-element-visual-studio-templates)します。  
