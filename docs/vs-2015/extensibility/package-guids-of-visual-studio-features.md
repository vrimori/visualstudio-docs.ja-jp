...
ms.locfileid: "47539937"
---
# <a name="package-guids-of-visual-studio-features"></a>Visual Studio の機能のパッケージ Guid
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[パッケージ Guid の Visual Studio 機能](https://docs.microsoft.com/visualstudio/extensibility/package-guids-of-visual-studio-features)します。  
