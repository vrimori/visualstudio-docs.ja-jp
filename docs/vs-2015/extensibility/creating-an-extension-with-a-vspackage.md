...
ms.locfileid: "47548061"
---
# <a name="creating-an-extension-with-a-vspackage"></a>VSPackage を使用した拡張機能の作成
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[VSPackage を使用した拡張機能の作成](https://docs.microsoft.com/visualstudio/extensibility/creating-an-extension-with-a-vspackage)です。  
