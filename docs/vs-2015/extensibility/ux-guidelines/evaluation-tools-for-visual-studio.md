...
ms.locfileid: "47547307"
---
# <a name="evaluation-tools-for-visual-studio"></a>Visual Studio の評価ツール
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[評価 Tools for Visual Studio](https://docs.microsoft.com/visualstudio/extensibility/ux-guidelines/evaluation-tools-for-visual-studio)します。  
