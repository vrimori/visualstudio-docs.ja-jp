...
このトピックの最新バージョンをご覧[EnableLocationBrowseButton 要素 (Visual Studio テンプレート)](https://docs.microsoft.com/visualstudio/extensibility/enablelocationbrowsebutton-element-visual-studio-templates)します。  
