...
このトピックの最新バージョンをご覧[、Microsoft Visual Studio リモート デバッグ モニターに接続できませんでした。](https://docs.microsoft.com/visualstudio/debugger/unable-to-connect-to-the-microsoft-visual-studio-remote-debugging-monitor)します。  
...
## <a name="the-local-and-remote-machines-have-different-authentication-modes"></a>ローカル コンピューターとリモート コンピューターの認証モードが異なる  
 ...
 認証モードの詳細については、次を参照してください。 [Windows 認証の概要](https://technet.microsoft.com/library/hh831472.aspx)します。  
