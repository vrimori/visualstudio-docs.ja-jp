...
ms.locfileid: "47534053"
---
# <a name="create-custom-views-of-managed-objects"></a>管理対象オブジェクトのカスタム ビューを作成します。
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[マネージ オブジェクトのカスタム ビューを作成する](https://docs.microsoft.com/visualstudio/debugger/create-custom-views-of-dot-managed-objects)します。  
