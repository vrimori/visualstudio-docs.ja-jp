...
このトピックの最新バージョンをご覧[idiaframedata::get_lengthlocals](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiaframedata-get-lengthlocals)します。  
