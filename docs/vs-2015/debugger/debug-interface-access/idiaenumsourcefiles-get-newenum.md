...
このトピックの最新バージョンをご覧[IDiaEnumSourceFiles::get__NewEnum](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiaenumsourcefiles-get-newenum)します。  
