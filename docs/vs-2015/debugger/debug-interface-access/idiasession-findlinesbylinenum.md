...
このトピックの最新バージョンをご覧[idiasession::findlinesbylinenum](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiasession-findlinesbylinenum)します。  
