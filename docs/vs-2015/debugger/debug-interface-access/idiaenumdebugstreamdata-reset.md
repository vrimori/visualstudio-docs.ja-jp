...
ms.locfileid: "47544698"
---
# <a name="idiaenumdebugstreamdatareset"></a>IDiaEnumDebugStreamData::Reset
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[idiaenumdebugstreamdata::reset](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiaenumdebugstreamdata-reset)します。  
