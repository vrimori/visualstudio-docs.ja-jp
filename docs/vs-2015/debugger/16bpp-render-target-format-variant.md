...
ms.locfileid: "47539879"
---
# <a name="16bpp-render-target-format-variant"></a>16bpp レンダリング ターゲット フォーマット バリアント
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[16 bpp レンダリング ターゲット フォーマット バリアント](https://docs.microsoft.com/visualstudio/debugger/graphics/16bpp-render-target-format-variant)します。  
