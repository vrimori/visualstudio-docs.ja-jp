...
ms.locfileid: "47536210"
---
# <a name="how-to-debug-com-servers"></a>方法 : COM サーバーをデバッグする
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[方法: COM サーバーのデバッグ](https://docs.microsoft.com/visualstudio/debugger/how-to-debug-com-servers)します。  
...
## <a name="see-also"></a>関連項目  
 ...
 [方法: COM クライアントおよびサーバーの RPC デバッグを使用したデバッグ](../debugger/how-to-debug-com-clients-and-servers-using-rpc-debugging.md)   
