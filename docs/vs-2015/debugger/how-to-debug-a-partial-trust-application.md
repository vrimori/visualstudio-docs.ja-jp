...
ms.locfileid: "47592734"
---
# <a name="how-to-debug-a-partial-trust-application"></a>方法 : 部分信頼アプリケーションをデバッグする
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[方法: 部分信頼アプリケーションをデバッグ](https://docs.microsoft.com/visualstudio/debugger/how-to-debug-a-partial-trust-application)します。  
