...
このトピックの最新バージョンをご覧[キーボードとマウスのショートカットをクラス ダイアグラムおよびクラスの詳細 ウィンドウ (クラス デザイナー) で](https://docs.microsoft.com/visualstudio/ide/keyboard-and-mouse-shortcuts-in-the-class-diagram-and-class-details-window-class-designer)します。  
