...
このトピックの最新バージョンをご覧[建物とクリーニングのプロジェクトと Visual Studio でソリューション](https://docs.microsoft.com/visualstudio/ide/building-and-cleaning-projects-and-solutions-in-visual-studio)します。  
