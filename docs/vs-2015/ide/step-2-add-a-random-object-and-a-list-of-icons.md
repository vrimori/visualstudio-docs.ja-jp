...
ms.locfileid: "47548072"
---
# <a name="step-2-add-a-random-object-and-a-list-of-icons"></a>手順 2: Random オブジェクトおよびアイコンのリストの追加
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[手順 2: Random オブジェクトおよびアイコンのリストを追加](https://docs.microsoft.com/visualstudio/ide/step-2-add-a-random-object-and-a-list-of-icons)します。  
