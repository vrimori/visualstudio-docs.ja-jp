...
-   **[Office アプリケーションを作成する](https://msdn.microsoft.com/library/fp161347.aspx)** : Office 365 サービスを使用して、Word、Excel、Outlook、および PowerPoint の拡張とカスタマイズを行う Office アプリケーションの作成を開始します。  
