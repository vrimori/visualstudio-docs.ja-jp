...
ms.locfileid: "47548988"
---
# <a name="user-permissions-and-visual-studio"></a>ユーザー アクセス許可と Visual Studio
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[ユーザーのアクセス許可と Visual Studio](https://docs.microsoft.com/visualstudio/ide/user-permissions-and-visual-studio)します。  
...
|領域|タスク|詳細情報|  
|----------|----------|--------------------------|  
|インストール|Visual Studio をインストールする。|[Visual Studio 2015 をインストールします。](../install/install-visual-studio-2015.md)|  
