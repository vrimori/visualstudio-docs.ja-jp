...
ms.locfileid: "47536161"
---
# <a name="step-3-assign-a-random-icon-to-each-label"></a>手順 3: 各ラベルへのランダムなアイコンの割り当て
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[手順 3: 各ラベルへのランダムなアイコンの割り当て](https://docs.microsoft.com/visualstudio/ide/step-3-assign-a-random-icon-to-each-label)します。  
