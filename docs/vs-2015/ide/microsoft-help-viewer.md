...
ms.locfileid: "47536988"
---
# <a name="microsoft-help-viewer"></a>Microsoft ヘルプ ビューアー
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[Microsoft ヘルプ ビューアー](https://docs.microsoft.com/visualstudio/ide/microsoft-help-viewer)します。  
  
Microsoft ヘルプ ビューアーを使用して、ローカル コンピューターにさまざまな製品のコンテンツやテクノロジをインストールして表示できます。  
  
> [!WARNING]
>  Visual Studio をインストールするときに、ヘルプ ビューアーを入手できます。 MSDN のダウンロード サイトではなく、ヘルプ ビューアーでヘルプ トピックの読み取りを開始するには、**ヘルプ** メニューの選択 Visual Studio で**ヘルプ設定**、し、**ヘルプの起動ビューアー**します。 特定のバージョンの Visual Studio のオフライン ヘルプ トピックは、そのバージョンの最終リリースの後にのみ使用できます。  
