...
ms.locfileid: "47533886"
---
# <a name="options-page-environment-node-properties"></a>[環境] ノード プロパティ ([オプション] ページ)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[オプション] ページで、[環境] ノード プロパティ](https://docs.microsoft.com/visualstudio/ide/reference/options-page-environment-node-properties)します。  
