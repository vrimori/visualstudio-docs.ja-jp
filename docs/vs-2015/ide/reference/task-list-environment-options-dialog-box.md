...
このトピックの最新バージョンをご覧[オプション ダイアログ ボックスのタスク List, Environment,](https://docs.microsoft.com/visualstudio/ide/reference/task-list-environment-options-dialog-box)します。  
