...
このトピックの最新バージョンをご覧[vc++ プロジェクトの設定、プロジェクトおよびソリューション オプション ダイアログ ボックス](https://docs.microsoft.com/visualstudio/ide/reference/vcpp-project-settings-projects-and-solutions-options-dialog-box)します。  
