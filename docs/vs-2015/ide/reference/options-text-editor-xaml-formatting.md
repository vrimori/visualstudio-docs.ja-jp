...
ms.locfileid: "47540122"
---
# <a name="options-text-editor-xaml-formatting"></a>[オプション]、[テキスト エディター]、[XAML]、[書式設定]
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[オプション、テキスト エディター、書式設定されている XAML](https://docs.microsoft.com/visualstudio/ide/reference/options-text-editor-xaml-formatting)します。  
