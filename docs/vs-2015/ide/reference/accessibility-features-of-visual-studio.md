...
ms.locfileid: "47534759"
---
# <a name="accessibility-features-of-visual-studio"></a>Visual Studio のユーザー補助機能
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[Visual Studio のアクセシビリティ機能](https://docs.microsoft.com/visualstudio/ide/reference/accessibility-features-of-visual-studio)します。  
