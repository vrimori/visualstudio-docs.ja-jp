...
> [!TIP]
>  データ ソース構成ウィザードを実行すると、ほとんどのデータ項目が自動的に作成され、構成されます。 詳細については、次を参照してください。 [Visual Studio でのデータ アプリケーションの作成](http://msdn.microsoft.com/en-us/28edce21-220a-484c-b461-a75b0232d293)です。  
