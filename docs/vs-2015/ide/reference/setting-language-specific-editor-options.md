...
ms.locfileid: "47544945"
---
# <a name="setting-language-specific-editor-options"></a>言語固有のフォルダー オプションの設定
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[言語固有のエディター オプションの設定](https://docs.microsoft.com/visualstudio/ide/reference/setting-language-specific-editor-options)します。  
