...
ms.locfileid: "47545155"
---
# <a name="startup-environment-options-dialog-box"></a>[スタートアップ] ([オプション] ダイアログ ボックス - [環境])
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[オプション ダイアログ ボックスの起動時に、環境、](https://docs.microsoft.com/visualstudio/ide/reference/startup-environment-options-dialog-box)します。  
