...
ms.locfileid: "47592822"
---
# <a name="cl-task"></a>CL タスク
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[CL タスク](https://docs.microsoft.com/visualstudio/msbuild/cl-task)します。  
...
-   **PreprocessorDefinitions**  
     ...
     詳細については、「[/D (プリプロセッサの定義)](http://msdn.microsoft.com/library/b53fdda7-8da1-474f-8811-ba7cdcc66dba)」を参照してください。  
