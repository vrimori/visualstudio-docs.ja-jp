...
ms.locfileid: "47548806"
---
# <a name="assignprojectconfiguration-task"></a>AssignProjectConfiguration タスク
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[AssignProjectConfiguration タスク](https://docs.microsoft.com/visualstudio/msbuild/assignprojectconfiguration-task)します。  
