...
ms.locfileid: "47548793"
---
# <a name="aspnetcompiler-task"></a>AspNetCompiler タスク
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[ASP.NET アプリケーションをプリコンパイルする AspNetCompiler タスクを使用して](https://docs.microsoft.com/visualstudio/msbuild/aspnetcompiler-task)します。  
