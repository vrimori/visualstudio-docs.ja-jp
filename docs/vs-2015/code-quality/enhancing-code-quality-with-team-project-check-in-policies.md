...
|タスク|関連する参照先|  
|----------|------------------------|  
|**チェックイン ポリシーの作成と使用:** [!INCLUDE[esprscc](../includes/esprscc-md.md)]のチーム プロジェクトの設定を使用して、チェックイン ポリシーを作成します。|[品質ゲートの設定と適用](http://msdn.microsoft.com/library/bdc5666e-6cf0-45b2-a0a1-133c3f61e852)|  
