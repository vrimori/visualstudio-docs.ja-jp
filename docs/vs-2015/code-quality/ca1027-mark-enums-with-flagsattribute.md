...
ms.locfileid: "47589793"
---
# <a name="ca1027-mark-enums-with-flagsattribute"></a>CA1027: FlagsAttribute で列挙値をマークします
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[CA1027: FlagsAttribute で列挙をマーク](https://docs.microsoft.com/visualstudio/code-quality/ca1027-mark-enums-with-flagsattribute)します。
