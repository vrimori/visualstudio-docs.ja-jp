...
このトピックの最新バージョンをご覧[ca 2131: セキュリティ クリティカルな型は型の等価性に参加できません](https://docs.microsoft.com/visualstudio/code-quality/ca2131-security-critical-types-may-not-participate-in-type-equivalence)します。
