...
ms.locfileid: "47592030"
---
# <a name="ca2216-disposable-types-should-declare-finalizer"></a>CA2216: 破棄できる型ではファイナライザーを宣言します
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[ca 2216: 破棄可能な型はファイナライザーを宣言する必要があります](https://docs.microsoft.com/visualstudio/code-quality/ca2216-disposable-types-should-declare-finalizer)します。
