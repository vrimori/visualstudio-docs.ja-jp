...
このトピックの最新バージョンをご覧[CA1013: オーバー ロードで、演算子 equals をオーバー ロードの加算および減算](https://docs.microsoft.com/visualstudio/code-quality/ca1013-overload-operator-equals-on-overloading-add-and-subtract)します。
