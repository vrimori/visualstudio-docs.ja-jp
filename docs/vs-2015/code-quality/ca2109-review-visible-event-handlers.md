---
title: 'Ca 2109: 表示するイベント ハンドラーをレビューする |Microsoft Docs'
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47589208"
---
# <a name="ca2109-review-visible-event-handlers"></a>CA2109: 表示するイベント ハンドラーをレビューします
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[ca 2109: 表示するイベント ハンドラーをレビュー](https://docs.microsoft.com/visualstudio/code-quality/ca2109-review-visible-event-handlers)します。
...
## <a name="see-also"></a>関連項目
 ...
 [セキュリティ要求](http://msdn.microsoft.com/en-us/324c14f8-54ff-494d-9fd1-bfd20962c8ba)
