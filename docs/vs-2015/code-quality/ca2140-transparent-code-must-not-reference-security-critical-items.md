...
このトピックの最新バージョンをご覧[ca 2140: 透過的コードは、セキュリティ上重要な項目は参照する必要があります](https://docs.microsoft.com/visualstudio/code-quality/ca2140-transparent-code-must-not-reference-security-critical-items)します。
