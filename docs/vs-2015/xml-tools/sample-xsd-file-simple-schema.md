---
title: 'サンプル XSD ファイル: シンプルなスキーマ |Microsoft Docs'
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47537622"
---
# <a name="sample-xsd-file-simple-schema"></a>サンプル XSD ファイル: シンプルなスキーマ
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[サンプル XSD ファイル: シンプルなスキーマ](https://docs.microsoft.com/visualstudio/xml-tools/sample-xsd-file-simple-schema)します。  
