...
ms.locfileid: "47536450"
---
# <a name="how-to-create-a-geometry-based-gradient-shader"></a>方法: ジオメトリベースのグラデーション シェーダーを作成する
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[方法: ジオメトリ ベースのグラデーション シェーダーを作成](https://docs.microsoft.com/visualstudio/designers/how-to-create-a-geometry-based-gradient-shader)です。  
