...
このトピックの最新バージョンをご覧[トラブルシューティングと既知の問題 (Visual Studio Tools for Unity)](https://docs.microsoft.com/visualstudio/cross-platform/troubleshooting-and-known-issues-visual-studio-tools-for-unity)します。  
