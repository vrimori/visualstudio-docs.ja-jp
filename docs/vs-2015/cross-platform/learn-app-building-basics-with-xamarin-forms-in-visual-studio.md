...
このトピックの最新バージョンをご覧[Visual Studio で xamarin.forms アプリ作成の基本事項](https://docs.microsoft.com/visualstudio/cross-platform/learn-app-building-basics-with-xamarin-forms-in-visual-studio)します。  
