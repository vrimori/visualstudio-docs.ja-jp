...
ms.locfileid: "47535778"
---
# <a name="attach-reference-strings-to-uml-model-elements"></a>UML モデル要素に参照文字列をアタッチする
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[モデル要素を UML に参照文字列をアタッチ](https://docs.microsoft.com/visualstudio/modeling/attach-reference-strings-to-uml-model-elements)します。  
