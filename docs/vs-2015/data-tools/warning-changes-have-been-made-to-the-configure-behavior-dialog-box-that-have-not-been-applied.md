 ...
 **動作の構成** ダイアログ ボックスでは、使用可能なすべてのクラスの Insert、Update、および Delete の動作を構成することができます。 新しい選択すると、このメッセージが表示されます**クラス**と**動作**と組み合わせ、以前の変更がまだ適用されていません。  
