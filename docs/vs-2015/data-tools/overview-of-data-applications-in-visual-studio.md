---
title: Visual Studio でのデータ アプリケーションの概要 |Microsoft Docs
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47535199"
---
# <a name="overview-of-data-applications-in-visual-studio"></a>Visual Studio のデータ アプリケーションの概要
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このセクションでは、一般にクライアントと中間層を対象とした Visual Studio アプリケーションでデータを処理する場合の情報および予備手順について説明します。  
  
## <a name="in-this-section"></a>このセクションの内容  
 [チュートリアル: 単純なデータ アプリケーションの作成](http://msdn.microsoft.com/library/c5d0968c-d86f-4ae9-a2e1-871f208a3bb3)  
 ...
 [Visual Studio でのオブジェクトのバインド](../data-tools/bind-objects-in-visual-studio.md)  
...
## <a name="related-sections"></a>関連項目  
 ...
 [!INCLUDE[vbtecdlinq](../includes/vbtecdlinq-md.md)]を使用して [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] クラスを作成する方法に関するトピックへのリンクを示します。  
