...
このトピックの最新バージョンをご覧[Visual Studio での Entity Data Model ツール](https://docs.microsoft.com/visualstudio/data-tools/entity-data-model-tools-in-visual-studio)します。  
