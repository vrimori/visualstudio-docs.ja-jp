...
ms.locfileid: "47536459"
---
# <a name="testing-a-large-application-with-multiple-ui-maps"></a>複数の UI マップでの大規模アプリケーションのテスト
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[複数の UI マップで大規模なアプリケーションのテスト](https://docs.microsoft.com/visualstudio/test/testing-a-large-application-with-multiple-ui-maps)します。  
