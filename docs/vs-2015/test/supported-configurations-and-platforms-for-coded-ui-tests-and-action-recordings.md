...
このトピックの最新バージョンをご覧[でサポートされる構成とプラットフォーム コード化された UI テストと操作の記録を](https://docs.microsoft.com/visualstudio/test/supported-configurations-and-platforms-for-coded-ui-tests-and-action-recordings)します。  
