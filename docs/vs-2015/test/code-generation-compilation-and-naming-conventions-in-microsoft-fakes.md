...
このトピックの最新バージョンをご覧[コード生成、コンパイル、および Microsoft Fakes における名前付け規則](https://docs.microsoft.com/visualstudio/test/code-generation-compilation-and-naming-conventions-in-microsoft-fakes)します。  
