...
このトピックの最新バージョンをご覧[Visual Studio 静的コード分析によるストア アプリの分析の C++ コード品質](https://docs.microsoft.com/visualstudio/test/analyze-cpp-code-quality-of-store-apps-using-visual-studio-static-code-analysis)します。  
