...
このトピックの最新バージョンをご覧[チュートリアル: Windows ストア アプリの単体テストの作成と実行](https://docs.microsoft.com/visualstudio/test/walkthrough-creating-and-running-unit-tests-for-windows-store-apps)します。  
