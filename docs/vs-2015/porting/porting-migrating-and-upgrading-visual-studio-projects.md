...
##  <a name="project"></a> プロジェクト  
 次の一覧は、[!INCLUDE[vs_dev11_long](../includes/vs-dev11-long-md.md)] または Visual Studio 2010 SP1 で作成したプロジェクトの [!INCLUDE[vs_dev14](../includes/vs-dev14-md.md)] または [!INCLUDE[vs_dev12](../includes/vs-dev12-md.md)] におけるサポートについての説明です。 この一覧を使用して、[!INCLUDE[vs_dev14](../includes/vs-dev14-md.md)]、[!INCLUDE[vs_dev12](../includes/vs-dev12-md.md)]、[!INCLUDE[vs_dev11_long](../includes/vs-dev11-long-md.md)]、または Visual Studio 2010 SP1 でそのままの状態でプロジェクトを開くことができるか、または互換性を確保するために変更する必要があるかを確認できます。  
...
|[!INCLUDE[net_v45](../includes/net-v45-md.md)]|作成してでプロジェクトを開く[!INCLUDE[vs_dev14](../includes/vs-dev14-md.md)]、[!INCLUDE[vs_dev12](../includes/vs-dev12-md.md)]と[!INCLUDE[vs_dev11_long](../includes/vs-dev11-long-md.md)]、Visual Studio 2010 SP1 ではなく。|  
