...
このトピックの最新バージョンをご覧[チュートリアル: ClickOnce 配置 API を使用したオンデマンドでアセンブリをダウンロード](https://docs.microsoft.com/visualstudio/deployment/walkthrough-downloading-assemblies-on-demand-with-the-clickonce-deployment-api)します。  
