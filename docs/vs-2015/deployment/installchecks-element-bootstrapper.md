...
ms.locfileid: "47546582"
---
# <a name="ltinstallchecksgt-element-bootstrapper"></a>&lt;InstallChecks&gt;要素 (ブートス トラップ)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このトピックの最新バージョンをご覧[ &lt;InstallChecks&gt;要素 (ブートス トラップ)](https://docs.microsoft.com/visualstudio/deployment/installchecks-element-bootstrapper)します。  
