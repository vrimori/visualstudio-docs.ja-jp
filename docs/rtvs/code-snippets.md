...
![コード スニペットを使って read.csv の呼び出しを挿入するアニメーション](~/docs/rtvs/media/code-snippet-expansion.gif)
...
![R の [コード スニペット マネージャー] ダイアログ ボックス](~/docs/rtvs/media/code-snippet-dialog.png)
