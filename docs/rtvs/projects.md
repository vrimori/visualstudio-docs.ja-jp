...
`.Rhistory` では、[[R インタラクティブ]](interactive-repl.md) ウィンドウに入力したすべてのコマンドが記録されます。 **[R ツール] > [Windows] > [履歴]** コマンドで、専用の履歴ウィンドウを開くことができます。 そのウィンドウには、履歴の内容を消去するためのツール バー ボタンとコンテキスト メニュー項目が含まれています。
