...
---
# オートメーション モデルの拡張
ここではオートメーション モデルと VSPackage モデルが [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] 環境の機能拡張に熊手 2 の方法を表す方法について説明します。  拡張機能はIDE 機能を強化し拡張することです。  一方オートメーションは既存の環境のタスクを自動化しプログラムによって IDE を生成するツールおよびユーザー定義コードを示します。  VSPackage は環境に追加する新しい機能ができます。  
...
## このセクションの内容  
 [オートメーション モデル](/visual-cpp/misc/automation-model)  
...
## 関連項目  
 ...
 オートメーションVSPackageまたはその両方を使用して [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] の機能拡張アプリケーションの作成方法について説明します。