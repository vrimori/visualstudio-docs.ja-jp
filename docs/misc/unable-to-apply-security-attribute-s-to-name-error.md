...
3.  エラーが引き続き発生する場合は、作業内容を保存し、[!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] を再起動します。  
  
4.  エラーがまだ発生する場合は、[!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] を再インストールします。  
