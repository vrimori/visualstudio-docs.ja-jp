...
[TextFieldParser Object](/dotnet/visual-basic/language-reference/objects/textfieldparser-object) に渡されたストリームを読み取ることができません。 テキスト ファイルではないファイルを読み取ろうとしている可能性があります。  
