...
## 戻り値  
 格納されている `t` の `param_type` パラメーター。  
  
## 解説  
 コード例については、「[binomial\_distribution クラス](/visual-cpp/standard-library/binomial-distribution-class)」を参照してください。  
...
## 参照  
 ...
 [binomial\_distribution クラス](/visual-cpp/standard-library/binomial-distribution-class)   
