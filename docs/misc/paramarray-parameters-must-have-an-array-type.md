...
2.  エラーがまだ発生する場合は、作業内容を保存し、[!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] を再起動します。  
  
3.  エラーが続く場合は、[!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] を再インストールします。  
