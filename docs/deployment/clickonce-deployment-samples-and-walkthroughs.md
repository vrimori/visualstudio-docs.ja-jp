---
title: ClickOnce 配置のサンプルとチュートリアル |Microsoft ドキュメント
ms.custom: ''
ms.date: 11/04/2016
...
|トピック|説明|  
|-----------|-----------------|  
|[ClickOnce アプリケーションを手動で配置します。](../deployment/walkthrough-manually-deploying-a-clickonce-application.md)|.NET Framework ユーティリティを使用して ClickOnce アプリケーションを配置する方法を説明します。|  
...
|[ClickOnce 配置 API デザイナーを使用してアセンブリをダウンロードします。](../deployment/walkthrough-downloading-assemblies-on-demand-with-the-clickonce-deployment-api-using-the-designer.md)|アプリケーションで初めて使用するときにのみアプリケーション アセンブリをダウンロードする方法を説明します。|  
