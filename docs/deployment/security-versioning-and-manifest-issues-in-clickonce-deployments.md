...
編集する場合にのみ、このエラーが発生することができます、[!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)]マニフェストを手動で Visual Studio を使用してデプロイを生成する場合にこのエラーを発生する必要がありますしない場合。
