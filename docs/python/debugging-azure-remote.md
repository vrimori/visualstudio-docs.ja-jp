...
![Azure Portal での Web ソケットの有効化](~/docs/python/media/azure-remote-debugging-enable-web-sockets.png)
...
![Azure App Service Web サイトのデバッグ](~/docs/python/media/azure-remote-debugging-attached.png)
...
![Azure リモート デバッグ プロキシの情報ページ](~/docs/python/media/azure-remote-debugging-proxy-info-page.png)
...
![Azure App Service 内のデバッガー エンドポイントの特定](~/docs/python/media/azure-remote-debugging-secret.png)
...
![[プロセスにアタッチ] ダイアログを使用した Azure Web サイトへの接続](~/docs/python/media/azure-remote-debugging-manual-attach.png)
