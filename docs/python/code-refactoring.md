...
1. 表示された **[名前の変更]** ダイアログで、識別子の新しい名前を入力し、**[OK]** を選択します。
  ...
  ![新しい識別子名を入力するための [名前の変更] プロンプト](~/docs/python/media/code-refactor-rename-1.png)

1. その次のダイアログで、名前変更を適用するコード内のファイルとインスタンスを選択します。特定の変更をプレビューするには、個別のインスタンスを選択します。

  ![変更の適用場所を選択するための [名前の変更] ダイアログ](~/docs/python/media/code-refactor-rename-2.png)
...
1. 表示されるダイアログ ボックスで新しいメソッドの名前を入力し、抽出先を指定して、クロージャ変数を選択します。 クロージャに選択されなかった変数はメソッド引数に返されます。
  ...
  ![[メソッドの抽出] ダイアログ](~/docs/python/media/code-refactor-extract-method-1.png)

1. **[OK]** を選択すると、指定に従ってコードが変更されます。

  ![メソッドの抽出の効果](~/docs/python/media/code-refactor-extract-method-2.png)
...
![[インポートの追加] スマート タグ](~/docs/python/media/code-refactor-add-import-1.png)
...
![インポートの追加の結果](~/docs/python/media/code-refactor-add-import-2.png)
...
![[Remove imports (インポートの削除)] メニュー](~/docs/python/media/code-refactor-remove-imports-1.png)

Visual Studio によってコードが適切に変更されます。

![インポートの削除の効果](~/docs/python/media/code-refactor-remove-imports-2.png)
