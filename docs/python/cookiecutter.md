...
![Cookiecutter のメイン ウィンドウ](~/docs/python/media/cookiecutter-overview.png)
...
![Cookiecutter のオプション ページ](~/docs/python/media/cookiecutter-template-options.png)
...
![ソリューション エクスプローラーのコマンドが表示された Cookiecutter](~/docs/python/media/cookiecutter-files-created.png)

## <a name="cookiecutter-options"></a>Cookiecutter のオプション

Cookiecutter のオプションは、**[ツール] > [オプション] > [Cookiecutter]** から表示できます。

![Cookiecutter のオプション](~/docs/python/media/cookiecutter-tools-options.png)
