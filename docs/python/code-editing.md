...
![メンバー入力候補](~/python/media/code-editing-completions-simple.png)
...
![フィルター処理されたメンバー入力候補](~/python/media/code-editing-completion-filtering.png)
...
![複数の型のメンバー入力候補](~/python/media/code-editing-completion-types.png)
...
![プライベートのメンバー入力候補](~/python/media/code-editing-completion-dunder.png)

`import` および `from ... import` ステートメントでは、インポートできるモジュールの一覧が表示されます。`from ... import` の場合は、指定したモジュールからインポートできるメンバーの一覧が表示されます。

![インポートの入力候補](~/python/media/code-editing-completion-import.png)
...
![例外の入力候補](~/python/media/code-editing-completion-exception.png)

@ を入力するとデコレーターが開始され、可能性があるデコレーターが表示されます。 これらの項目の多くはデコレーターとして使用できないため、ライブラリのドキュメントを確認して、どれを使用するかを判断する必要があります。

![デコレーターの入力候補](~/python/media/code-editing-completion-decorator.png)
...
![シグネチャ ヘルプ](~/python/media/code-editing-signature-help.png)
...
![クイック ヒント](~/python/media/code-editing-quick-info.png)
...
![コードの色分け表示](~/python/media/code-editing-code-coloring.png)

使用する色をカスタマイズするには、**[ツール] > [オプション] > [環境] > [フォントおよび色]** に移動し、**[表示アイテム]** の一覧で Python のエントリを変更します。

![[フォントおよび色] のオプション](~/python/media/code-editing-customize-colors.png)
...
![コード スニペット](~/python/media/code-editing-code-snippets.png)

利用可能なコード スニペットは、コード スニペット マネージャーで確認できます (**[ツール] > [コード スニペット マネージャー]**) を選択し、言語として **[Python]** を選択します。

![コード スニペット マネージャー](~/python/media/code-editing-code-snippets-manager.png)
...
![ナビゲーション バー](~/python/media/code-editing-navigation-bar.png)
...
![[定義へ移動]](~/python/media/code-editing-go-to-definition.png)
...
![[移動]](~/python/media/code-editing-navigate-to.png)
...
![[すべての参照の検索] の結果](~/python/media/code-editing-find-all-references.png)
