...
##  <a name="applevel"></a> Excel 用の VSTO アドインの開発  
 ...
 ![ビデオへのリンク](~/docs/data-tools/media/playvideo.gif "ビデオへのリンク") 関連するビデオ デモについては、「[操作方法: Excel のアドインで PowerPoint を自動化する](http://go.microsoft.com/fwlink/?LinkID=130300)」をご覧ください。  
