...
# Outlook のリボンのカスタマイズ
 ...
 ![ビデオへのリンク](~/docs/data-tools/media/playvideo.gif "ビデオへのリンク") 関連のビデオ デモについては、「[操作方法: リボン デザイナーを使用して Outlook のリボンをカスタマイズする](http://go.microsoft.com/fwlink/?LinkID=130312)」を参照してください。  
