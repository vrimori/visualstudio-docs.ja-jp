...
# 方法 : サービスのデータをドキュメントに読み込む
 ...
 ![ビデオへのリンク](~/docs/data-tools/media/playvideo.gif "ビデオへのリンク") 関連するビデオ デモについては、「[方法: Microsoft Excel から Web サービスと対話する](http://go.microsoft.com/fwlink/?LinkID=130284)」を参照してください。  
