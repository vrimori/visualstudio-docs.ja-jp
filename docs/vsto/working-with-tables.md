...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "テーブル [Visual Studio での Office 開発]"
  - "Office ドキュメント [Visual Studio での Office 開発]、テーブル"
  - "Word [Visual Studio での Office 開発]、テーブル"
  - "ドキュメント [Visual Studio での Office 開発]、テーブル"
