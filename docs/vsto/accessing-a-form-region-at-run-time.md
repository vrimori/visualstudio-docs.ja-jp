---
title: "実行時にフォーム領域へのアクセス |Microsoft ドキュメント"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
### <a name="imported-form-regions"></a>インポートされたフォーム領域  
 ...
 C# でのプロパティを作成する方法の詳細については、次を参照してください。[する方法: 宣言と使用 読み取り、書き込みのプロパティ &#40;です。C &#35;です。プログラミング ガイド &#41;](/dotnet/csharp/programming-guide/classes-and-structs/how-to-declare-and-use-read-write-properties).  
