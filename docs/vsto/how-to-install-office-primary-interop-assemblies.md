---
title: "方法: Office プライマリ相互運用機能アセンブリのインストール |Microsoft ドキュメント"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
2.  Microsoft Office をインストールことを確認して、 **.NET プログラミング サポート**拡張するアプリケーションの機能が選択されている (この機能は既定のインストールに含まれています)。  
