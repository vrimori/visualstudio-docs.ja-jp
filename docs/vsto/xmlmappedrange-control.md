---
title: "XmlMappedRange コントロール | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
# XmlMappedRange コントロール
 ...
 ![ビデオへのリンク](../vsto/media/playvideo.png "ビデオへのリンク") 関連のビデオ デモについては、「[How Do I: Use XML Mapping in Excel? \(操作方法: Excel で XML マッピングを使用する\)](http://go.microsoft.com/fwlink/?LinkID=130288)」を参照してください。  
