...
-   [Word、InfoPath、および PowerPoint](#WordAndInfoPath)  
 ...
 ![ビデオへのリンク](~/docs/data-tools/media/playvideo.gif "ビデオへのリンク") 関連のビデオ デモについては、「[操作方法: Word の VSTO アドインで作業ウィンドウを管理する](http://go.microsoft.com/fwlink/?LinkId=136781)」をご覧ください。  
