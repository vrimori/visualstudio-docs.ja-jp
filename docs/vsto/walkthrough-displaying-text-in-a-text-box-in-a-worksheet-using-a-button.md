...
1.  名前の Excel ブック プロジェクトを作成する**マイ Excel ボタン**します。 必ず**新しい文書を作成**が選択されています。 詳細については、次を参照してください。[方法: Visual Studio でプロジェクトを作成する Office](../vsto/how-to-create-office-projects-in-visual-studio.md)します。  
