---
title: "方法: プログラムによって予定を作成 |Microsoft ドキュメント"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
# <a name="how-to-programmatically-create-appointments"></a>方法: プログラムによって予定を作成する
  この例では、予定を作成し、予定会議出席依頼に受信者を追加します。  
...
## <a name="see-also"></a>参照  
 ...
 [方法: プログラムによってカスタムの予定表を作成します。](../vsto/how-to-programmatically-create-a-custom-calendar.md)   
