---
title: "ユーザー インターフェイス リファレンス (Visual Studio での Office 開発) |Microsoft ドキュメント"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 [発行ウィザード (&) #40 です。 Office の開発 Visual Studio &#41;](../vsto/publish-wizard-office-development-in-visual-studio.md)  
