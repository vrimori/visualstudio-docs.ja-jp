 ...
 **Dinner Now の支払いシステムのコード マップ**  
 ...
 ![PaymentProcessing の依存関係の内部メソッド](~/docs/modeling/media/depgraph_expandeddn.png "DepGraph_ExpandedDN")  
...
###  <a name="a-namedefineclassesa-define-a-glossary-of-types-class-diagrams"></a><a name="DefineClasses"></a>型の用語集の定義: クラス ダイアグラム  
 ...
 ![Process Payment のエンティティ クラス ダイアグラムで](~/docs/modeling/media/uml_payentities.png "UML_PayEntities")  
