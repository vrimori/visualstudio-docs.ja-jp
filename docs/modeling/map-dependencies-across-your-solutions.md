...
6.  マップ上の項目に関連する項目をさらに表示するには、1 つを選択し、コード マップ ツールバーで **[関連表示]** を選択して、マップに追加する関連項目の種類を選択します。 代わりに、1 つまたは複数の項目を選択して、ショートカット メニューを開きを選択し、**を表示しています.**マップへの追加に関連する項目の種類のオプションです。 例:  
