...
## 問題を把握する  
 ...
 ![コード マップ &#45; コードの検索](~/docs/modeling/media/codemapstoryboardpaint1.png "CodeMapStoryboardPaint1")  
...
## コードのマップを開始する  
 ...
 ![コード マップ &#45; メソッドおよび関連するフィールドの表示](~/docs/modeling/media/codemapstoryboardpaint3.png "CodeMapStoryboardPaint3")  
...
## コード間のリレーションシップを把握する  
 ...
 ![コード エディターからコード マップを開く](~/docs/modeling/media/codemapstoryboardpaint6a.PNG "CodeMapStoryboardPaint6A")  
