---
title: "Visual Studio のモデリング SDK の API リファレンス |Microsoft ドキュメント"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
|<xref:Microsoft.VisualStudio.Modeling.Integration.Shell?displayProperty=fullName>|Modelbus アダプター フレームワークの[!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)]します。|  
...
|<xref:Microsoft.VisualStudio.Modeling.Shell?displayProperty=fullName>|Dsl の間のインターフェイスと[!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)]です。|  
