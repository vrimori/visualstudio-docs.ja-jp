...
-   コード内の自然な依存関係クラスターを確認します。 マップ ツールバーで、次のように選択します。**レイアウト**、**クイック クラスター**![クイック クラスター ボタンのグラフ ツールバーを](../modeling/media/quickclustersicon.gif)です。 参照してください[レイアウトを変更するマップ](#Selecting)です。
...
|マップ上の他のノードやグループとは独立して、グループ内のレイアウトを変更します。|ノードを選択して、ショートカット メニューを開きます。 選択**レイアウト**とレイアウト スタイルを選択します。<br /><br /> または<br /><br /> ノードを選択して展開し、子ノードを表示します。 グループのポップアップ ツールバーを表示して開くノード タイトルをクリックして、**グループのレイアウト スタイルを変更する**![依存関係グラフ&#45;グループ ツールバー&#45;レイアウト](../modeling/media/dependencygraph_grouptoolbar.gif) ボックスの一覧です。 ツリー レイアウトを選択**クイック クラスター**、または**リスト ビュー** (するグループのコンテンツに整列一覧)。<br /><br /> 参照してください[グループ ノード](#OrganizeGroups)詳細についてはします。|
...
|マップのサイズを変更してウィンドウに合わせます。|選択**に合わせて大きさ**から、**ズーム**コード マップ ツールバーのリスト。<br /><br /> または<br /><br /> クリックして、**に合わせてズーム**アイコン![マップ ツールバーのズーム アイコン](../modeling/media/almcodemapzoomicon.png)コード マップ ツールバーでします。 キーボードの使用: キーを押して**CTRL +0** (ゼロ)。|
|マップ上のノードを名前で検索します。 **ヒント:** マップ上の項目についてのみ有効です。 ソリューション内ではなく、マップにアイテムを検索するでこれらを見つけ**ソリューション エクスプ ローラー**、し、マップにドラッグします。 (選択内容をドラッグするか、ツールバー、ソリューション エクスプ ローラーをクリックして**コード マップに表示**)。|1.選択、**検索**アイコン![マップ ツールバーで、検索アイコン](../modeling/media/almcodemapfindicon.png)コード マップ ツールバーで (キーボード: キーを押して**ctrl キーを押しながら F**) マップの右上隅に、検索ボックスを表示します。<br />2.項目の名前とキーを押して入力**返す**か「拡大鏡」アイコンをクリックします。 マップの選択としたときに、検索条件に一致する最初の項目が表示されます。<br />3.検索をカスタマイズするには、ドロップダウン リストを開き、検索オプションを選択します。 オプションは、**次を検索**、**前を検索**、および**すべて選択**です。 次に、[検索] ボックスの横にある対応するボタンをクリックします。<br />     ![検索オプションのドロップダウン&#45;ボックスの一覧](../modeling/media/almcodemapssearchdropdown.png)<br />     または、キーボードを使用して: キーを押します**F3**を次に一致するノードを選択または**shift キーを押しながら F3**を前の一致するノードを選択します。<br />4.検索テキスト ボックスの下のアイコンをクリックして、検索語句の処理方法を指定するオプションのいずれかを選択します。<br />     ![検索の一致のオプション](../modeling/media/almcodemapssearchmatchicons.png)<br />     オプションは、左から順に、大文字と小文字を区別して検索、完全に一致する単語だけを検索、.NET の正規表現の構文を使用して検索、囲まれた項目と一致する項目が表示されるようにグループを自動的に展開する、となっています。 **重要:** それらのグループが既に展開している場合にのみ、折りたたまれたグループで一致を検索する検索ボックスを使用することができます。 これらの一致を検索し、親グループを自動的に展開するには、検索ボックスでこのオプションを選択します。|
...
> [!TIP]
>  既定では、マップには選択したノードのグループ間リンクのみが表示されます。 グループ間の集約されたリンクを非表示には、この動作を変更するをクリックして**レイアウト**コードにツールバーをマップし、選択**詳細**、し**すべてのグループ間リンクの表示**または**すべてグループ間リンクを非表示に**です。 参照してください[非表示または表示するノードとリンク](#HidingShowing)詳細についてはします。
...
|非表示のノードを表示します。|、グループ内のすべての隠しノードを表示するにはまず、グループが展開を確認します。 ショートカット メニューを開き**選択**、**子の再表示**です。<br />     または<br />     をクリックして、**子の再表示**![子の再表示アイコン](../modeling/media/dependencygraph_filtericon_hiddennodes.gif)(これは表示されている非表示の子ノードがある場合にのみ)、グループの左上隅のアイコン。<br />、すべての隠しノードを表示するにはマップまたはノードのショートカット メニューを開き**選択**、**すべて再表示**です。|
...
|グループ内のレイアウトを変更します。|グループの選択で、ショートカット メニューを開き、**レイアウト**、レイアウト スタイルを選択するとします。<br /><br /> または<br /><br /> 1.グループを選択し、そのグループが展開されているかどうかを確認します。<br />2.グループ ヘッダーをもう一度クリックすると、グループ ツールバーが表示されます。<br />     ![依存関係グラフ&#45;グループ ツールバー](../modeling/media/dependencygraph_group.png)<br />3.開く、**グループのレイアウト スタイルを変更する**リスト![依存関係グラフ&#45;グループ ツールバー&#45;レイアウト](../modeling/media/dependencygraph_grouptoolbar.gif)するレイアウト スタイルを選択します。<br /><br /> **リスト ビュー**リストに、グループのメンバーを並べ替えます。 **既定のグラフ**マップの既定のレイアウトにグループのレイアウトをリセットします。 その他のオプションでは、次を参照してください。[レイアウトを変更するマップ](#Selecting)です。|
...
|選択したノードをグループ化します。|1.グループ化するノードを選択します。 選択した最後のノードの上に、ポップアップ ツールバーが表示されます。<br />     ![依存関係のグラフ ツールバー](../modeling/media/depedencygraph_toolbar.png)<br />2.ツールバーで、4 つ目のアイコンを選択 **、選択したノードをグループ化**(ノードを展開してある場合は 4 つのアイコンではなく 5)。 キーを押して、新しいグループの名前を入力**返す**です。<br />     または<br />     グループ化するノードを選択して、選択した項目のショートカット メニューを開きます。 選択**グループ**、**親グループの追加**、キーを押して、新しいグループの名前を入力**返す**です。<br /><br /> グループ名は変更できます。 グループのショートカット メニューを開き**編集**、**プロパティ**を Visual Studio プロパティ ウィンドウを開きます。 **ラベル**プロパティ、必要に応じてグループの名前を変更します。|
...
|既存のノードと同じ種類のノードを追加し、既存のノードからリンクを追加します。|1.コード要素を選択します。 その上にポップアップ ツールバーが表示されます。<br />     ![依存関係のグラフ ツールバー](../modeling/media/depedencygraph_toolbar.png)<br />2.ツールバーで、2 番目のアイコンを選択**このノードと同じカテゴリのノードを作成し、新しいリンクを追加して**です。<br />3.新しいコード要素を配置するマップ上の場所を選択して、マウスの左ボタンをクリックします。<br />4.キーを押して、新しいノードの名前を入力**返す**です。|
