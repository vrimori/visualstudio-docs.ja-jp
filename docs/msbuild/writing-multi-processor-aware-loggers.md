...
### 中央ログ モデル  
 ...
 ![中心ロガー モデル](~/docs/msbuild/media/centralnode.png "CentralNode")  
...
### 分散ログ モデル  
 ...
 ![分散ログ モデル](~/docs/msbuild/media/distnode.png "DistNode")  
...
## ConfigurableForwardingLogger を使用した簡単な分散ログ  
