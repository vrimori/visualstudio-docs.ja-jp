...
|タイトル|説明|  
|----------|--------|  
|[バッチ](../msbuild/msbuild-batching.md)|項目メタデータに基づいてビルドのターゲットとタスクをバッチ処理する方法について説明します。|  
...
|[最適な使用方法](../msbuild/msbuild-best-practices.md)|MSBuild スクリプトを記述するためのベスト プラクティスを紹介します。|  
