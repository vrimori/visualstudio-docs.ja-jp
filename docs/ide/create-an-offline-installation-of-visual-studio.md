...
* **Visual Studio 2017 RC** の場合は、docs.microsoft.com の [Visual Studio 2017 のオフライン インストールの作成](../install/create-an-offline-installation-of-visual-studio.md)に関するページを参照してください。
