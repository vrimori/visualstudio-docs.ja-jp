---
title: "手順 11: プログラムの実行とその他の機能の使用 | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
2.  ピクチャを開く前に、**[Set the background color]** ボタンをクリックします。 **[色]** ダイアログ ボックスが表示されます。  
     ...
     ![[色] ダイアログ ボックス](~/docs/ide/media/express_colordialog.png "Express_ColorDialog")  
[色] ダイアログ ボックス  
...
-   Visual C# の詳細については、「[Introduction to the C# Language and the .NET Framework](/dotnet/csharp/getting-started/introduction-to-the-csharp-language-and-the-net-framework)」 (C# 言語と .NET Framework の概要) を参照してください。  
