...
###  <a name="a-namerenamingtypesandmembersa-renaming-types-and-type-members"></a><a name="RenamingTypesAndMembers"></a> 型および型のメンバーの名前変更  
...
###  <a name="a-namemovingtypemembersa-moving-type-members-from-one-type-to-another"></a><a name="MovingTypeMembers"></a>&1; つの型から別の型への型のメンバーの移動  
