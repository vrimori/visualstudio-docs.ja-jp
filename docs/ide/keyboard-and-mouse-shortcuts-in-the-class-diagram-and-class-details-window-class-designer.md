...
-   [[クラスの詳細] ウィンドウでマウスを使用する](../Topic/Keyboard%20and%20Mouse%20Shortcuts%20in%20the%20Class%20Diagram%20and%20Class%20Details%20Window%20\(Class%20Designer\).md#MouseClassDetails)  
...
-   [[クラスの詳細] ウィンドウでキーボードを使用する](../Topic/Keyboard%20and%20Mouse%20Shortcuts%20in%20the%20Class%20Diagram%20and%20Class%20Details%20Window%20\(Class%20Designer\).md#KeyboardClassDetails)  
...
> [!NOTE]
>  次のキー バインディングは、コードを入力する場合の動作に特に類似したものとなるように選ばれています。  
