...
---
# <a name="finding-and-replacing-text"></a>テキストの検索と置換
 ...
 **[検索]** コントロールは、**[出力]** ウィンドウや **[検索結果]** ウィンドウなどのコード ウィンドウまたはテキスト ウィンドウでも使用できます。これには、**[編集]** メニューの **[検索と置換]** をクリックするか、**Ctrl キーを押しながら F キー**を押します。  
