...
ms.topic: "article"
helpviewer_keywords: 
  - "CodeIndex コマンド [Team Foundation Server]"
  - "コマンド ライン ツール [Team Foundation Server]"
  - "TFSConfig"
 ...
 **CodeIndex** コマンドを使用するには、**Team Foundation 管理者**セキュリティ グループのメンバーである必要があります。  「[Permission reference for Team Foundation Server](../Topic/Permission%20reference%20for%20Team%20Foundation%20Server.md)」を参照してください。  
...
## 参照  
 [Managing server configuration with TFSConfig](http://msdn.microsoft.com/ja-jp/94424190-3b6b-4f33-a6b6-5807f4225b62)   
 [Command\-line tools for TFS](http://msdn.microsoft.com/ja-jp/be8c997a-b97b-4e59-97f5-04db0a601a6c)