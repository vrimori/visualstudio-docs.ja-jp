# [Visual Studio IDE の概要](visual-studio-ide.md)
# IDE クイックスタート
## [Visual Studio IDE の表示の紹介](quickstart-ide-orientation.md)
## [テーマとテキストの色のカスタマイズ](quickstart-personalize-the-ide.md)
## [エディター内のコーディング](quickstart-editor.md)
...
#### [コードのスタイル設定](code-styles-and-quick-actions.md)
...
### [Visual Basic の IntelliSense](visual-basic-specific-intellisense.md)
