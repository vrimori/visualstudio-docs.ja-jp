...
![[進む] と [戻る] のナビゲーション ボタン](~/docs/ide/media/vs2017_nav_buttons.png)

コード エディターの構造ビジュアライザーは、*構造のガイド線*、つまりコードベース内の対応する中かっこを示す縦の点線を表示する機能です。 ガイド線を表示すると、論理ブロックの開始位置と終了位置がわかりやすくなります。

![構造ビジュアライザー](~/docs/ide/media/vside_structure_visualizer.png)
...
|呼び出し階層の表示|(コンテキスト メニューまたは Ctrl + K、Ctrl + T)。|  
 ...
 ![コード ナビゲーション バー](~/docs/ide/media/vside_navigation_bar.png)
...
1. テキスト ボックスに、検索するコード要素の名前を入力します。
    ...
    ![[移動] ウィンドウ](~/docs/ide/media/vside_navigatetowindow.png "[移動] ウィンドウ")
...
![[移動] ウィンドウ - 大文字を使用した検索](~/docs/ide/media/vside_capitalsearch.png)
...
![[すべての参照の検索] ツール ウィンドウ](~/docs/ide/media/vside_findallreferences.png)
