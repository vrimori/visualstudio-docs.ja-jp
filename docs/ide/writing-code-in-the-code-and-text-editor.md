...
## <a name="navigate-in-the-code-window"></a>コード ウィンドウ内の移動  
 ...
 ![[進む] と [戻る] のナビゲーション ボタン](../ide/media/vs2015_nav_buttons.png "VS2015_Nav_buttons")  
...
![[移動] ウィンドウ - 大文字を使用した検索](../ide/media/vside_capitalsearch.png "[移動] ウィンドウ - 大文字を使用した検索")
...
-   [Visual Basic の設定](/dotnet/visual-basic/developing-apps/using-ide/settings)  
