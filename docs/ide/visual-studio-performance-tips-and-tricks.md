...
- **プロジェクトをアンロードする**
    ...
    **ソリューション エクスプローラー**の右クリック コンテキスト メニューを使って、使用頻度の低いプロジェクトを個別に手動でアンロードできます。
...
- **完全なソリューション分析を無効にする**
    ...
    **完全なソリューション分析**を無効にするには、**[ツール]** > **[オプション]** > **[テキスト エディター]** > **[Visual Basic] または [C#]** の順に選択します。 **[詳細]** を選び、**[完全ソリューション解析を有効にする]** をオフにします。
