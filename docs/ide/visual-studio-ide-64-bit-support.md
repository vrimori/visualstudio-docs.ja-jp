...
## <a name="debugging-a-64-bit-application"></a>64 ビット アプリケーションのデバッグ  
 [!INCLUDE[vsprvslong](../code-quality/includes/vsprvslong_md.md)] を 64 ビット Windows オペレーティング システムで実行している場合、エディット コンティニュは機能しません。 次のトピックでは、64 ビット アプリケーションのデバッグについて説明しています。  
