...
**クラス デザイナー**を使用すると、クラスや型をビジュアル化できるだけでなく、デザインすることもできます。  この方法については、次のトピックを参照してください。  
  
> [!NOTE]
>  クラス デザイナーで作業する場合は、生成されたコードを実行前に検査して、コードがセキュリティ コンテキストに対して適切であることを確認する必要があります。  
  
## このセクションの内容  
 [How to: Create Types by using Class Designer](../ide/how-to-create-types-by-using-class-designer.md)  
  
 クラス ダイアグラムを使用して型を作成する方法について説明します。  
  
 [How to: Create Inheritance Between Types \(Class Designer\)](../ide/how-to-create-inheritance-between-types-class-designer.md)  
  
 型の継承関係を定義する方法について説明します。  
 ...
 クラス デザイナーを使用した型のメンバーの作成方法と構成方法について説明し、関連するトピックへのリンクを示します。  
