...
|領域|説明|  
|----------|-----------------|  
|[Windows デベロッパー センターのサンプル](http://go.microsoft.com/fwlink/?LinkID=255278)|[!INCLUDE[win8_appname_long](../debugger/includes/win8_appname_long_md.md)] のアプリケーションを開発する方法を示します。|  
|[.NET Framework のサンプル](http://msdn.microsoft.com/en-us/177055f8-4a1f-43e7-aee6-995c196079b1)|C# と Visual Basic の [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)] のさまざまな側面を示します。|  
...
|[Office 開発のサンプル](/office-dev/office-dev/office-development-samples)|Visual Studio 内で Office 開発ツールを使用する方法を示します。 最新のサンプルについては、「 [コード レシピ: サンプルコードから学ぶ](http://go.microsoft.com/fwlink/?LinkID=248199)」をご覧ください。|  
