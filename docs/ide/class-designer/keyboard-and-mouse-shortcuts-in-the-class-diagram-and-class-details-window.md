...
## <a name="using-the-mouse-in-class-designer"></a>クラス デザイナーでマウスを使用する  
...
## <a name="using-the-mouse-in-the-class-details-window"></a>[クラスの詳細] ウィンドウでマウスを使用する  
...
## <a name="using-the-keyboard-in-class-designer"></a>クラス デザイナーでキーボードを使用する  
...
## <a name="using-the-keyboard-in-the-class-details-window"></a>[クラスの詳細] ウィンドウでキーボードを使用する  
