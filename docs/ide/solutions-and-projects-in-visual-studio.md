---
title: "Visual Studio のソリューションおよびプロジェクト | Microsoft Docs"
ms.custom: ""
ms.date: "11/16/2016"
ms.reviewer: ""
ms.suite: ""
...
helpviewer_keywords: 
  ...
  - "ソリューション エクスプ ローラーでフォルダー、ソリューションの項目"
  - "共有のソリューション項目"
  - "ソリューション [Visual Studio]"
  - "プロジェクト項目の概要のプロジェクト項目 [Visual Studio]"
  - "ワークスペース"
  - "デザイン ソリューション [Visual Studio]"
  - "プロジェクト [Visual Studio]"
  - "ソリューション [Visual Studio] を投影し、"
  - "vs.solutionpropertypages.projectdependencies"
  - "アプリケーション [Visual Studio]"
  - "セットアップ プロジェクト [Visual Studio]"
  - "[その他のファイル]"
...
> [!NOTE]
>  ソリューションまたはプロジェクトは必要に応じて使用します。 Visual Studio にファイルを開くだけでし、コードの編集を開始できます。 詳細については、「[Open Any Folder with Visual Studio](https://blogs.msdn.microsoft.com/visualstudio/2016/04/12/open-any-folder-with-visual-studio-15-preview/)」 (Visual Studio でフォルダーを開く) を参照してください。
 ...
 ![Visual Studio のプロジェクトとソリューション](../ide/media/vs2015_project_diagram.png "vs2015_project_diagram")  
