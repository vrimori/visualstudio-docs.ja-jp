...
### <a name="add-using"></a>using を追加します。  
 ...
 ![スマート タグ イメージを使用して追加](~/docs/ide/media/addusesmart.gif "AddUseSmart")  
 ...
 ![拡張スマート タグ イメージを使用して追加](~/docs/ide/media/addusesmartexp.gif "AddUseSmartExp")  
...
## <a name="generate-event-handlers"></a>イベント ハンドラーの生成  
 ...
 ![オート フック ボタン](~/docs/ide/media/vxautohookup.gif "vxAutoHookUp")  
 ...
 ![イベント ハンドラーの作成](~/docs/ide/media/vxgenerateeventhandler.gif "vxGenerateEventHandler")  
