---
title: '[テキスト エディター] ([オプション] ダイアログ ボックス)'
ms.date: 11/04/2016
...
「[コード エディターの機能](../../ide/writing-code-in-the-code-and-text-editor.md)」では、コード エディターを使うためのさまざまな方法について説明されています。