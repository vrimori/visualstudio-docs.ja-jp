---
title: "クラスまたは型の生成 - コード生成 (Visual Basic) | Microsoft Docs"
ms.custom: 
ms.date: 11/17/2016
ms.reviewer: 
ms.suite: 
...
1. まだ存在しないクラスを使用したことを示す赤い波線がある行にカーソルを置きます。
   ...
   ![強調表示されたコード](media/class-highlight-vb.png)
...
1. **[新しい型の生成...]** 項目を選択した場合、ダイアログ ボックスがポップアップし、いくつかの追加操作を実行できます。
   ...
   ![型の生成](media/class-newtype-vb.png)
...
1. クラス/構造体と、その使用から推論されたコンストラクターが、自動的に作成されます。
   ...
   ![クラス生成の結果](media/class-result-vb.png)
