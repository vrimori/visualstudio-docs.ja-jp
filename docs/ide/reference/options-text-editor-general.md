...
|マージン オン|マージン オフ|  
|-------------------------|--------------------------|  
|![HTMLpageSelectionMarginOn スクリーンショット](~/docs/ide/reference/media/vxselmaron.gif "vxSelmaron")|![HTMLpageSelectionMarginOff スクリーンショット](~/docs/ide/reference/media/vxselmaroff.gif "vxSelmaroff")|  
