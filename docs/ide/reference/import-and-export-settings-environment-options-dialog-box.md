...
このページを使用して、ユーザー設定ファイルの保存先とチーム設定ファイルを使用するかどうかを指定します。  設定の詳細については、「[Customizing Development Settings in Visual Studio](http://msdn.microsoft.com/ja-jp/22c4debb-4e31-47a8-8f19-16f328d7dcd3)」を参照してください。  
