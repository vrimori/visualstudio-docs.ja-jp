---
title: "Visual Studio エディターのカスタマイズ | Microsoft Docs"
ms.custom: 
ms.date: 11/20/2017
ms.reviewer: 
ms.suite: 
...
一般のテキスト エディターまたは特定のプログラミング言語のテキスト エディターの書式設定、タブ、フォント、色、IntelliSense などの多くの機能をカスタマイズすることができます。 このセクションのトピックでは、これらのカスタマイズのいくつかの実行方法を示します。
