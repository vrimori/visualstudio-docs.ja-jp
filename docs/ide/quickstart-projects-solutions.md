...
1. 左側のウィンドウで、**[Visual C#]** を展開し、**[Windows デスクトップ]** を選択します。 次に、中央のウィンドウで、**[空のプロジェクト (.NET Framework)]** を選択します。 プロジェクトに "QuickDate" という名前を付けて **[OK]** ボタンをクリックします。
