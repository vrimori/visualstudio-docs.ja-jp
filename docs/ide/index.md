        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Visual Studio でのコードのデバッグに関する詳細情報</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <p><a href="/visualstudio/ide/reference/visual-studio-reference">Visual Studio IDE リファレンス</a></p>
                        <p><a href="/visualstudio/ide/reference/visual-studio-commands">Visual Studio コマンド</a></p>
                        <p><a href="/visualstudio/ide/reference/devenv-command-line-switches">Devenv コマンド ライン スイッチ</a></p>
                    </div>
                </div>
            </div>
        </div>
