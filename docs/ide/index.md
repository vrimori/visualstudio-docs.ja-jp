...
titleSuffix: ''
description: Visual Studio がさまざまなプログラミング言語を使用したアプリの開発にどのように役立つかについて説明します。
ms.date: 01/01/2018
layout: LandingPage
author: gewarren
ms.author: gewarren
...
ms.locfileid: "53060026"
---
# <a name="visual-studio-documentation"></a>Visual Studio ドキュメント

Visual Studio がさまざまなプログラミング言語を使用したアプリの開発にどのように役立つかについて説明します。
チュートリアル、ビデオ、その他のドキュメントで、Visual Studio を使用してコードとアプリを作成する方法について説明します。
            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            <h3>Visual Studio をインストールして設定する方法について</h3>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Microsoft Virtual Academy での Visual Studio 2017</h3>
                    </div>
                </div>
            </div>
        </div>
...
## <a name="experience-visual-studio-with-5-minute-quickstarts"></a>5 分間の "クイック スタート" で Visual Studio を使ってみる
...
## <a name="go-deeper-with-tutorials"></a>チュートリアルでさらに詳しく理解する
...
src="https://docs.microsoft.com/media/common/i_debug.svg"><span>デバッグ</span></a></div>