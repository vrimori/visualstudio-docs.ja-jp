...
すべてのテスト クラスには `TestClass` 属性が必要であり、すべてのテスト メソッドには `TestMethod` 属性が必要です。 詳細については、「[単体テストの構造](http://msdn.microsoft.com/a03d1ee7-9999-4e7c-85df-7d9073976144)」を参照してください。
