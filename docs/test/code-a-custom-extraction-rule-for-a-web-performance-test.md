---
title: Visual Studio での Web パフォーマンス テストのカスタム抽出規則のコーディング | Microsoft Docs
ms.date: 10/19/2016
ms.topic: article
helpviewer_keywords:
- extraction rules
...
---
# <a name="coding-a-custom-extraction-rule-for-a-web-performance-test"></a>Web パフォーマンス テストのカスタム抽出規則のコーディング
