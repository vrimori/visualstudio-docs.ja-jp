...
1.  Web パフォーマンス テストを作成していない場合は、「[Record a web performance test](/vsts/load-test/run-performance-tests-app-before-release#create-a-web-performance-and-load-test-project)」(Web パフォーマンス テストの記録) を参照してください。
