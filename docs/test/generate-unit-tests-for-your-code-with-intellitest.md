...
### 探索: IntelliTest を使用してコードを確認し、単体テストを生成する  
...
### 支援: IntelliTest を使用してコードの探索に重点を置く  
...
### 指定: コードで指定した正確性プロパティを検証するために IntelliTest を使用する  
...
### Q: 生成されたテストはどのような場合に合格または失敗しますか。  
...
### Q: パラメーター化された単体テストに前提事項を追加できますか。  
...
### Q: IntelliTest で他の単体テスト フレームワークを使用することはできますか。  
