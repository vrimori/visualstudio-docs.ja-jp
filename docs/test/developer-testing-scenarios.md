...
XAML ベースの Windows ストア アプリ、ブラウザー アプリ、および SharePoint アプリなど、さまざまなテクノロジをカバーする UI テストを自動化できます。
...
* [コード化された UI テストを使用して Windows ストア アプリをテストする](test-windows-store-8-1-apps-with-coded-ui-tests.md)
