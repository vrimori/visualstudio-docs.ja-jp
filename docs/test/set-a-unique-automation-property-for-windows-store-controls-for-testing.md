...
---
# テスト用に Windows ストア コントロールの一意のオートメーション プロパティを設定する
...
## いくつかの方法で一意のオートメーション プロパティを割り当てる  
 ...
 **既存のコントロールに一意の名前を付けるには**  
 ...
 ![&#91;ツール&#93; メニューの &#91;対話型要素に名前を付ける&#93; をクリック](../test/media/cuit_windowsstoreproperty_blend_1.png "CUIT\_WindowsStoreProperty\_Blend\_1")  
  
 **作成されるコントロールに自動的に一意の名前を付けるには**  
  
 **\[ツール\]** メニューの **\[オプション\]** をポイントし、**\[プロジェクト\]** をクリックします。  次に示すように、**\[対話要素の作成時に自動的に名前を付ける\]** を選択し、**\[OK\]** をクリックします。  
  
 ![対話型要素に名前を付けるためプロジェクトを設定](../test/media/cuit_windowsstoreproeprty_blend_2.png "CUIT\_WindowsStoreProeprty\_Blend\_2")  
...
## 参照  
 [コード化された UI テストを使用した Windows ストア 8.1 アプリのテスト](../test/test-windows-store-8-1-apps-with-coded-ui-tests.md)