...
1.  [Xamarin を使用した Visual Studio におけるモバイル アプリ](https://visualstudio.microsoft.com/xamarin/) (visualstudio.com) は、Xamarin の主要な特性についての簡単な概要を提供します。
...
詳細については、[Microsoft Emulator for Windows 10 Mobile を使用するテスト](/windows/uwp/debug-test-perf/test-with-the-emulator)に関するページをお読みください。
