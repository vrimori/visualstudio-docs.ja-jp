...
##  <a name="a-nameprereqa-pre-requisites"></a><a name="prereq"></a> 前提条件  
  
1.  Xamarin アカウント: [https://www.xamarin.com/](https://www.xamarin.com/) にアクセスし、ページの右上にある **[Sign In]** をクリックした後、表示されるページで **[Create a new account]** をクリックします。 Xamarin アカウントの電子メール アドレスとパスワードを選択します。この情報は後で使用します。  
  
2.  Windows と Android を対象とする場合:  
...
##  <a name="a-namewindowsa-windows-setup-visual-studio-and-xamarin"></a><a name="windows"></a> Windows のセットアップ (Visual Studio と Xamarin)  
