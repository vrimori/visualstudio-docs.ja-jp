...
##  <a name="FeaturesTest"></a> エミュレーターでテストできる機能  
 エミュレーターでテストできる機能について詳しくは、この[ドキュメント](http://blogs.msdn.com/b/visualstudioalm/archive/2014/11/12/introducing-visual-studio-s-emulator-for-android.aspx)をご覧ください。  
...
-   [android エミュレーター](http://stackoverflow.com/questions/tagged/android-emulator) および visual studio タグを使用して、StackOverflow で質問を投稿します。  
