...
1. 正しいホスト ポート (この例では 1337) の Chrome プロセスを選び、**[アタッチ]** を選択します。
...
このチュートリアルでは、Node.js と React アプリを作成し、JSX をトランスパイルして、デバッグする方法を説明しました。 詳細については、[GitHub で Node.js Tools for Visual Studio](https://github.com/Microsoft/nodejstools) を参照してください。