...
1. **[新しいプロジェクト]** ダイアログ ボックスで、左ウィンドウの **[JavaScript]** を展開し、**[Node.js]** を選択します。 真ん中のウィンドウで **[基本の Azure Node.js Express 4 アプリケーション]** を選択し、**[OK]** を選択します。
    ...
    ![プロジェクトの構造](../nodejs/media/tutorial-project-structure.png)
...
このチュートリアルでは、Express を使用して Node.js アプリを作成して実行し、デバッガーを使用してブレークポイントに到達する方法について学びました。 詳細については、[GitHub で Node.js Tools for Visual Studio](https://github.com/Microsoft/nodejstools) を参照してください。