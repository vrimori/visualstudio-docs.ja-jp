...
これから Visual Studio デバッガーがアタッチされた状態でアプリを実行します。 その前に、ブレークポイントを設定する必要があります。
...
> [Visual Studio の Node.js ツール](https://github.com/Microsoft/nodejstools)