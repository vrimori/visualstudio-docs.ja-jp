---
title: "IDebugDocumentText::GetSize |Microsoft ドキュメント"
ms.custom: 
ms.date: 01/18/2017
...
#### <a name="parameters"></a>パラメーター  
 `pcNumLines`  
 [out]ドキュメント内の行の数。 このパラメーターが NULL の場合、メソッドは値を返しません。  
  
 `pcNumChars`  
 [out]ドキュメント内の文字の数。 このパラメーターが NULL の場合、メソッドは値を返しません。  
