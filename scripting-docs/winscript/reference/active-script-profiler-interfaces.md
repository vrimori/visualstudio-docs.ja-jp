---
title: "アクティブ スクリプト プロファイラーのインターフェイス |Microsoft ドキュメント"
ms.custom: 
ms.date: 01/18/2017
