---
title: IEnumRemoteDebugApplicationThreads::Next |Microsoft ドキュメント
ms.custom: ''
ms.date: 01/18/2017
...
#### <a name="parameters"></a>パラメーター  
 ...
 `pprdat`  
 [out]配列を返します`IRemoteDebugApplicationThread`を取得してセグメントを表すインターフェイス。  
