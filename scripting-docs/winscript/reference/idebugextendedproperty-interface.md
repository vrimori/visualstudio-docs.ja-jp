---
title: IDebugExtendedProperty インターフェイス |Microsoft ドキュメント
ms.custom: ''
ms.date: 01/18/2017
...
|メソッド|説明|  
|------------|-----------------|  
|[IDebugExtendedProperty::GetExtendedPropertyInfo](../../winscript/reference/idebugextendedproperty-getextendedpropertyinfo.md)|取得、`ExtendedDebugPropertyInfo`これを説明します。`IDebugExtendedProperty``.`|  
