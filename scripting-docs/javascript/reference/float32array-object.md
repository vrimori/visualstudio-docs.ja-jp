---
title: "Float32Array オブジェクト | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
## パラメーター  
 `float32Array`  
 必ず指定します。  **Float32Array** オブジェクトを代入する変数名を指定します。  
...
|定数|説明|  
|--------|--------|  
|[BYTES\_PER\_ELEMENT 定数](../../javascript/reference/bytes-per-element-constant-float32array.md)|配列の各要素のサイズ \(バイト単位\)。|  
