---
title: Math.sin 関数 (JavaScript) |Microsoft ドキュメント
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24638522"
---
# <a name="mathsin-function-javascript"></a>Math.sin 関数 (JavaScript)
サイン (正弦) を返します。  
