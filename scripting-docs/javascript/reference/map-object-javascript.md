---
title: "Map オブジェクト (JavaScript) | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
|プロパティ|説明|  
|-----------|--------|  
|[コンストラクター](../../javascript/reference/constructor-property-map.md)|マップを作成する関数を指定します。|  
|[prototype](../../javascript/reference/prototype-property-map.md)|マップのプロトタイプへの参照を返します。|  
...
|[delete](../../javascript/reference/delete-method-map-javascript.md)|指定された要素をマップから削除します。|  
...
|[has](../../javascript/reference/has-method-map-javascript.md)|マップが指定した要素を格納している場合、`true` を返します。|  
