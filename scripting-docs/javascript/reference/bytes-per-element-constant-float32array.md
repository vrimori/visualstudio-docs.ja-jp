---
title: BYTES_PER_ELEMENT 定数 (Float32Array) |Microsoft ドキュメント
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24633572"
---
# <a name="bytesperelement-constant-float32array"></a>BYTES_PER_ELEMENT 定数 (Float32Array)
配列の各要素のサイズ (バイト単位)。  
