---
title: subarray メソッド (Uint32Array) |Microsoft ドキュメント
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24639972"
---
# <a name="subarray-method-uint32array"></a>subarray メソッド (Uint32Array)
新しい Uint32Array ビューを取得、 [ArrayBuffer オブジェクト](../../javascript/reference/arraybuffer-object.md)サブ配列の最初と最後のメンバーを指定し、この配列に格納します。  
