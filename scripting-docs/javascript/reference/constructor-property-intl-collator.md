---
title: "constructor プロパティ (Intl.Collator) |Microsoft ドキュメント"
ms.custom: 
ms.date: 01/18/2017
...
---
# <a name="constructor-property-intlcollator"></a>constructor プロパティ (Intl.Collator)
Collator を作成する関数を指定します。  
