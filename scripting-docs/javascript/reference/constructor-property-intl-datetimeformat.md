---
title: "constructor プロパティ (Intl.DateTimeFormat) |Microsoft ドキュメント"
ms.custom: 
ms.date: 01/18/2017
...
---
# <a name="constructor-property-intldatetimeformat"></a>constructor プロパティ (Intl.DateTimeFormat)
フォーマッタを作成する関数を指定します。  
...
## <a name="remarks"></a>コメント  
 `dateTimeFormatter` はフォーマッタの名前で、必須です。  
