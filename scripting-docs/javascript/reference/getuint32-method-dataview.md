---
title: "getUint32 メソッド (DataView) | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
指定されたビューの先頭からのバイト オフセット位置にある Uint32 値を取得します。  配置の制約はありません。オフセットからマルチバイト値がフェッチされている場合があります。  
...
## パラメーター  
 `testInt`  
 必須です。  メソッドから返される Uint32 値を指定します。  
...
## 使用例  
 DataView の最初の Uint32 を取得する方法の例を次に示します。  
