...
<sup>1</sup> *Not for Resale (NFR)、Visual Studio Industry Partner (VSIP)、Microsoft Certified Trainer、BizSpark が含まれます。FTE、Microsoft Valued Partner (MVP)、Region Director (RD)、Microsoft Partner Network (MPN)、Imagine は含まれません。*
