...
1.  特定のサブスクライバー グループを検索するには、テーブル上部の **[フィルター]** をクリックします。

    ![サブスクライバーのフィルター](_img\edit-license\filter-list.png)

2.  検索基準として使用できる多数のフィールドが表示されます。 検索の基準として使う条件を選び、**[フィルター]** をクリックします。 選んだ条件に一致するサブスクライバーの一覧が表示されます。
![サブスクライバーを検索する](_img\search-filter\search-filter-find.png)
