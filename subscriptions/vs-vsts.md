---
title: Visual Studio サブスクリプションの VSTS 特典 | Microsoft Docs
author: evanwindom
ms.author: jaunger
manager: evelynp
ms.date: 03/15/2018
ms.topic: Get-Started-Article
description: Visual Studio サブスクライバーとして Visual Studio Team Services (VSTS) を使用する方法について説明します。
...
アクティブな Visual Studio サブスクライバーは、特典としてサブスクリプションに含まれる、VSTS のさまざまな機能を使用することができます。 自分でアカウントを作成したか、他のユーザーによって追加されたかにかかわらず、メンバーである各 VSTS アカウントでこれらの同じ機能を使用できます。
