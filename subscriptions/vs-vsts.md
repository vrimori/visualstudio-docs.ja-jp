---
title: "Visual Studio Team Services の特典"
Author: evanwindom
Ms.author: jaunger
Manager: evelynp
Ms.date: 10/3/2017
...
ほとんどの Visual Studio サブスクリプションには、Visual Studio Team Services (VSTS) へのアクセスが含まれます。  VSTS は IDE の究極の補完機能であり、あらゆる言語を対象とした無料の Git リポジトリ、アジャイル計画ツール、ホスト型ビルドを提供します。  
