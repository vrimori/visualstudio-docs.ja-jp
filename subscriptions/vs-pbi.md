...
### <a name="q--can-the-power-bi-pro-benefit-included-in-my-subscription-be-used-in-a-production-environment"></a>Q: 自分のサブスクリプションに含まれる Power BI Pro の特典を運用環境で使用することはできますか。
A: できます。  
