---
title: "過剰に要求されたライセンスの処理 | Visual Studio Marketplace"
Author: evanwindom
Ms.author: jaunger
Manager: evelynp
Ms.date: 10/3/2017
...
**注: Open License プログラムでは過剰に要求されたサブスクリプション シナリオは許可されません。**
...
![過剰に要求されたサブスクリプションを削除する](_img\over-claimed\delete-over-claimed.png)